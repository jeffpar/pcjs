...
node dx.js "9908BETACD1.iso" --desc --truncate > desc.txt
while true; do
...
node dx.js "ARMEFPP_EN.iso" --desc --truncate > desc.txt
while true; do
...
node dx.js "BETACD10310.iso" --desc --truncate > desc.txt
while true; do
    python update.py ms-technet-betacd10310 "Microsoft TechNet BETACD10310 Disc (October 2003)" desc.txt
    if [ $? -eq 0 ]; then break; fi
    sleep 300
done
...
node dx.js "BETACD10312.iso" --desc --truncate > desc.txt
while true; do
...
node dx.js "BETACD10403.iso" --desc --truncate > desc.txt
while true; do
...
node dx.js "BETACD10405.iso" --desc --truncate > desc.txt
while true; do
...
node dx.js "BETACD19911.iso" --desc --truncate > desc.txt
while true; do
...
node dx.js "BETA_EN_0223.05.iso" --desc --truncate > desc.txt
while true; do
...
node dx.js "BETA_EN_0223.06.iso" --desc --truncate > desc.txt
while true; do
...
node dx.js "BETA_EN_0223.07.iso" --desc --truncate > desc.txt
while true; do
...
node dx.js "BETA_EN_0223.08.iso" --desc --truncate > desc.txt
while true; do
...
node dx.js "BETA_EN_0223.09.iso" --desc --truncate > desc.txt
while true; do
...
node dx.js "BETA_EN_0223.10.iso" --desc --truncate > desc.txt
while true; do
...
node dx.js "BETA_EN_0223.11.iso" --desc --truncate > desc.txt
while true; do
...
node dx.js "BETA_EN_0223.12.iso" --desc --truncate > desc.txt
while true; do
...
node dx.js "BETA_EN_0223.13.iso" --desc --truncate > desc.txt
while true; do
    python update.py ms-technet-beta_en_0223.13 "Microsoft TechNet BETA_EN_0223.13 Disc (September 2006)" desc.txt
    if [ $? -eq 0 ]; then break; fi
    sleep 300
done
...
node dx.js "BORK2ND_ED.iso" --desc --truncate > desc.txt
while true; do
...
node dx.js "BORK4.5INTLA.iso" --desc --truncate > desc.txt
while true; do
...
node dx.js "BR0ECD2FRE_EN.iso" --desc --truncate > desc.txt
while true; do
...
node dx.js "BRMECD2XFRE_EN.iso" --desc --truncate > desc.txt
while true; do
...
node dx.js "BRMEFPP_EN.iso" --desc --truncate > desc.txt
while true; do
...
node dx.js "BRMEXFPP_EN.iso" --desc --truncate > desc.txt
while true; do
...
node dx.js "BTS2002EVAL_EN.iso" --desc --truncate > desc.txt
while true; do
...
node dx.js "BTS2004EVAL_EN.iso" --desc --truncate > desc.txt
while true; do
...
node dx.js "BTS2004_EN.iso" --desc --truncate > desc.txt
while true; do
    python update.py ms-technet-bts2004_en "Microsoft TechNet BTS2004_EN Disc (November 2005)" desc.txt
    if [ $? -eq 0 ]; then break; fi
    sleep 300
done
...
node dx.js "CSD9602.iso" --desc --truncate > desc.txt
while true; do
    python update.py ms-technet-csd9602 "Microsoft TechNet CSD9602 Disc (February 1996)" desc.txt
    if [ $? -eq 0 ]; then break; fi
    sleep 300
done
...
node dx.js "CSD9604.iso" --desc --truncate > desc.txt
while true; do
    python update.py ms-technet-csd9604 "Microsoft TechNet CSD9604 Disc (April 1996)" desc.txt
    if [ $? -eq 0 ]; then break; fi
    sleep 300
done
...
node dx.js "DL_C0294.01.iso" --desc --truncate > desc.txt
while true; do
    python update.py ms-technet-dl_c0294.01 "Microsoft TechNet DL_C0294.01 Disc (July 2007)" desc.txt
    if [ $? -eq 0 ]; then break; fi
    sleep 300
done
...
node dx.js "DOM35ENUC1.iso" --desc --truncate > desc.txt
while true; do
    python update.py ms-technet-dom35enuc1 "Microsoft TechNet DOM35ENUC1 Disc (November 2002)" desc.txt
    if [ $? -eq 0 ]; then break; fi
    sleep 300
done
...
node dx.js "DOM35ENUC2.iso" --desc --truncate > desc.txt
while true; do
    python update.py ms-technet-dom35enuc2 "Microsoft TechNet DOM35ENUC2 Disc (November 2002)" desc.txt
    if [ $? -eq 0 ]; then break; fi
    sleep 300
done
...
node dx.js "DOM46ENUC1.iso" --desc --truncate > desc.txt
while true; do
    python update.py ms-technet-dom46enuc1 "Microsoft TechNet DOM46ENUC1 Disc (October 2003)" desc.txt
    if [ $? -eq 0 ]; then break; fi
    sleep 300
done
...
node dx.js "DOM46ENUC2.iso" --desc --truncate > desc.txt
while true; do
    python update.py ms-technet-dom46enuc2 "Microsoft TechNet DOM46ENUC2 Disc (October 2003)" desc.txt
    if [ $? -eq 0 ]; then break; fi
    sleep 300
done
...
node dx.js "DOM47ENUC1.iso" --desc --truncate > desc.txt
while true; do
    python update.py ms-technet-dom47enuc1 "Microsoft TechNet DOM47ENUC1 Disc (November 2003)" desc.txt
    if [ $? -eq 0 ]; then break; fi
    sleep 300
done
...
node dx.js "DOM47ENUC2.iso" --desc --truncate > desc.txt
while true; do
    python update.py ms-technet-dom47enuc2 "Microsoft TechNet DOM47ENUC2 Disc (November 2003)" desc.txt
    if [ $? -eq 0 ]; then break; fi
    sleep 300
done
...
node dx.js "DOM48ENUC1.iso" --desc --truncate > desc.txt
while true; do
    python update.py ms-technet-dom48enuc1 "Microsoft TechNet DOM48ENUC1 Disc (December 2003)" desc.txt
    if [ $? -eq 0 ]; then break; fi
    sleep 300
done
...
node dx.js "DOM48ENUC2.iso" --desc --truncate > desc.txt
while true; do
    python update.py ms-technet-dom48enuc2 "Microsoft TechNet DOM48ENUC2 Disc (December 2003)" desc.txt
    if [ $? -eq 0 ]; then break; fi
    sleep 300
done
...
node dx.js "DOM49ENUC1.iso" --desc --truncate > desc.txt
while true; do
    python update.py ms-technet-dom49enuc1 "Microsoft TechNet DOM49ENUC1 Disc (January 2004)" desc.txt
    if [ $? -eq 0 ]; then break; fi
    sleep 300
done
...
node dx.js "DOM49ENUC2.iso" --desc --truncate > desc.txt
while true; do
    python update.py ms-technet-dom49enuc2 "Microsoft TechNet DOM49ENUC2 Disc (January 2004)" desc.txt
    if [ $? -eq 0 ]; then break; fi
    sleep 300
done
...
node dx.js "DOM50ENUC1.iso" --desc --truncate > desc.txt
while true; do
    python update.py ms-technet-dom50enuc1 "Microsoft TechNet DOM50ENUC1 Disc (February 2004)" desc.txt
    if [ $? -eq 0 ]; then break; fi
    sleep 300
done
...
node dx.js "DOM50ENUC2.iso" --desc --truncate > desc.txt
while true; do
    python update.py ms-technet-dom50enuc2 "Microsoft TechNet DOM50ENUC2 Disc (February 2004)" desc.txt
    if [ $? -eq 0 ]; then break; fi
    sleep 300
done
...
node dx.js "DOM51ENUC1.iso" --desc --truncate > desc.txt
while true; do
    python update.py ms-technet-dom51enuc1 "Microsoft TechNet DOM51ENUC1 Disc (March 2004)" desc.txt
    if [ $? -eq 0 ]; then break; fi
    sleep 300
done
...
node dx.js "DOM51ENUC2.iso" --desc --truncate > desc.txt
while true; do
    python update.py ms-technet-dom51enuc2 "Microsoft TechNet DOM51ENUC2 Disc (March 2004)" desc.txt
    if [ $? -eq 0 ]; then break; fi
    sleep 300
done
...
node dx.js "DOM52ENUC1.iso" --desc --truncate > desc.txt
while true; do
    python update.py ms-technet-dom52enuc1 "Microsoft TechNet DOM52ENUC1 Disc (April 2004)" desc.txt
    if [ $? -eq 0 ]; then break; fi
    sleep 300
done
...
node dx.js "DOM52ENUC2.iso" --desc --truncate > desc.txt
while true; do
    python update.py ms-technet-dom52enuc2 "Microsoft TechNet DOM52ENUC2 Disc (April 2004)" desc.txt
    if [ $? -eq 0 ]; then break; fi
    sleep 300
done
...
node dx.js "DOM53ENUC1.iso" --desc --truncate > desc.txt
while true; do
    python update.py ms-technet-dom53enuc1 "Microsoft TechNet DOM53ENUC1 Disc (May 2004)" desc.txt
    if [ $? -eq 0 ]; then break; fi
    sleep 300
done
...
node dx.js "DOM53ENUC2.iso" --desc --truncate > desc.txt
while true; do
    python update.py ms-technet-dom53enuc2 "Microsoft TechNet DOM53ENUC2 Disc (May 2004)" desc.txt
    if [ $? -eq 0 ]; then break; fi
    sleep 300
done
...
node dx.js "DOM54ENUC1.iso" --desc --truncate > desc.txt
while true; do
    python update.py ms-technet-dom54enuc1 "Microsoft TechNet DOM54ENUC1 Disc (June 2004)" desc.txt
    if [ $? -eq 0 ]; then break; fi
    sleep 300
done
...
node dx.js "DOM54ENUC2.iso" --desc --truncate > desc.txt
while true; do
    python update.py ms-technet-dom54enuc2 "Microsoft TechNet DOM54ENUC2 Disc (June 2004)" desc.txt
    if [ $? -eq 0 ]; then break; fi
    sleep 300
done
...
node dx.js "DOM55ENUC1.iso" --desc --truncate > desc.txt
while true; do
    python update.py ms-technet-dom55enuc1 "Microsoft TechNet DOM55ENUC1 Disc (July 2004)" desc.txt
    if [ $? -eq 0 ]; then break; fi
    sleep 300
done
...
node dx.js "DOM55ENUC2.iso" --desc --truncate > desc.txt
while true; do
    python update.py ms-technet-dom55enuc2 "Microsoft TechNet DOM55ENUC2 Disc (July 2004)" desc.txt
    if [ $? -eq 0 ]; then break; fi
    sleep 300
done
...
node dx.js "DOM56ENUC1.iso" --desc --truncate > desc.txt
while true; do
    python update.py ms-technet-dom56enuc1 "Microsoft TechNet DOM56ENUC1 Disc (August 2004)" desc.txt
    if [ $? -eq 0 ]; then break; fi
    sleep 300
done
...
node dx.js "DOM56ENUC2.iso" --desc --truncate > desc.txt
while true; do
    python update.py ms-technet-dom56enuc2 "Microsoft TechNet DOM56ENUC2 Disc (August 2004)" desc.txt
    if [ $? -eq 0 ]; then break; fi
    sleep 300
done
...
node dx.js "DOM68ENUC1.iso" --desc --truncate > desc.txt
while true; do
    python update.py ms-technet-dom68enuc1 "Microsoft TechNet DOM68ENUC1 Disc (August 2005)" desc.txt
    if [ $? -eq 0 ]; then break; fi
    sleep 300
done
...
node dx.js "DOM68ENUC2.iso" --desc --truncate > desc.txt
while true; do
    python update.py ms-technet-dom68enuc2 "Microsoft TechNet DOM68ENUC2 Disc (August 2005)" desc.txt
    if [ $? -eq 0 ]; then break; fi
    sleep 300
done
...
node dx.js "DOM69ENUC1.iso" --desc --truncate > desc.txt
while true; do
    python update.py ms-technet-dom69enuc1 "Microsoft TechNet DOM69ENUC1 Disc (September 2005)" desc.txt
    if [ $? -eq 0 ]; then break; fi
    sleep 300
done
...
node dx.js "DOM69ENUC2.iso" --desc --truncate > desc.txt
while true; do
    python update.py ms-technet-dom69enuc2 "Microsoft TechNet DOM69ENUC2 Disc (September 2005)" desc.txt
    if [ $? -eq 0 ]; then break; fi
    sleep 300
done
...
node dx.js "DOM70ENUC1.iso" --desc --truncate > desc.txt
while true; do
    python update.py ms-technet-dom70enuc1 "Microsoft TechNet DOM70ENUC1 Disc (October 2005)" desc.txt
    if [ $? -eq 0 ]; then break; fi
    sleep 300
done
...
node dx.js "DOM70ENUC2.iso" --desc --truncate > desc.txt
while true; do
    python update.py ms-technet-dom70enuc2 "Microsoft TechNet DOM70ENUC2 Disc (October 2005)" desc.txt
    if [ $? -eq 0 ]; then break; fi
    sleep 300
done
...
node dx.js "DOM71ENUC1.iso" --desc --truncate > desc.txt
while true; do
    python update.py ms-technet-dom71enuc1 "Microsoft TechNet DOM71ENUC1 Disc (November 2005)" desc.txt
    if [ $? -eq 0 ]; then break; fi
    sleep 300
done
...
node dx.js "DOM71ENUC2.iso" --desc --truncate > desc.txt
while true; do
    python update.py ms-technet-dom71enuc2 "Microsoft TechNet DOM71ENUC2 Disc (November 2005)" desc.txt
    if [ $? -eq 0 ]; then break; fi
    sleep 300
done
...
node dx.js "DOM72ENUC1.iso" --desc --truncate > desc.txt
while true; do
    python update.py ms-technet-dom72enuc1 "Microsoft TechNet DOM72ENUC1 Disc (December 2005)" desc.txt
    if [ $? -eq 0 ]; then break; fi
    sleep 300
done
...
node dx.js "DOM72ENUC2.iso" --desc --truncate > desc.txt
while true; do
    python update.py ms-technet-dom72enuc2 "Microsoft TechNet DOM72ENUC2 Disc (December 2005)" desc.txt
    if [ $? -eq 0 ]; then break; fi
    sleep 300
done
...
node dx.js "DOM73ENUC1.iso" --desc --truncate > desc.txt
while true; do
    python update.py ms-technet-dom73enuc1 "Microsoft TechNet DOM73ENUC1 Disc (January 2006)" desc.txt
    if [ $? -eq 0 ]; then break; fi
    sleep 300
done
...
node dx.js "DOM73ENUC2.iso" --desc --truncate > desc.txt
while true; do
    python update.py ms-technet-dom73enuc2 "Microsoft TechNet DOM73ENUC2 Disc (January 2006)" desc.txt
    if [ $? -eq 0 ]; then break; fi
    sleep 300
done
...
node dx.js "DOM74ENUC1.iso" --desc --truncate > desc.txt
while true; do
    python update.py ms-technet-dom74enuc1 "Microsoft TechNet DOM74ENUC1 Disc (February 2006)" desc.txt
    if [ $? -eq 0 ]; then break; fi
    sleep 300
done
...
node dx.js "DOM74ENUC2.iso" --desc --truncate > desc.txt
while true; do
    python update.py ms-technet-dom74enuc2 "Microsoft TechNet DOM74ENUC2 Disc (February 2006)" desc.txt
    if [ $? -eq 0 ]; then break; fi
    sleep 300
done
...
node dx.js "DOM75ENUC1.iso" --desc --truncate > desc.txt
while true; do
    python update.py ms-technet-dom75enuc1 "Microsoft TechNet DOM75ENUC1 Disc (March 2006)" desc.txt
    if [ $? -eq 0 ]; then break; fi
    sleep 300
done
...
node dx.js "DOM75ENUC2.iso" --desc --truncate > desc.txt
while true; do
    python update.py ms-technet-dom75enuc2 "Microsoft TechNet DOM75ENUC2 Disc (March 2006)" desc.txt
    if [ $? -eq 0 ]; then break; fi
    sleep 300
done
...
node dx.js "DOM76ENUC1.iso" --desc --truncate > desc.txt
while true; do
    python update.py ms-technet-dom76enuc1 "Microsoft TechNet DOM76ENUC1 Disc (April 2006)" desc.txt
    if [ $? -eq 0 ]; then break; fi
    sleep 300
done
...
node dx.js "DOM76ENUC2.iso" --desc --truncate > desc.txt
while true; do
    python update.py ms-technet-dom76enuc2 "Microsoft TechNet DOM76ENUC2 Disc (April 2006)" desc.txt
    if [ $? -eq 0 ]; then break; fi
    sleep 300
done
...
node dx.js "DOM77ENUC1.iso" --desc --truncate > desc.txt
while true; do
    python update.py ms-technet-dom77enuc1 "Microsoft TechNet DOM77ENUC1 Disc (May 2006)" desc.txt
    if [ $? -eq 0 ]; then break; fi
    sleep 300
done
...
node dx.js "DOM77ENUC2.iso" --desc --truncate > desc.txt
while true; do
    python update.py ms-technet-dom77enuc2 "Microsoft TechNet DOM77ENUC2 Disc (May 2006)" desc.txt
    if [ $? -eq 0 ]; then break; fi
    sleep 300
done
...
node dx.js "DOM78ENUC1.iso" --desc --truncate > desc.txt
while true; do
    python update.py ms-technet-dom78enuc1 "Microsoft TechNet DOM78ENUC1 Disc (June 2006)" desc.txt
    if [ $? -eq 0 ]; then break; fi
    sleep 300
done
...
node dx.js "DOM78ENUC2.iso" --desc --truncate > desc.txt
while true; do
    python update.py ms-technet-dom78enuc2 "Microsoft TechNet DOM78ENUC2 Disc (June 2006)" desc.txt
    if [ $? -eq 0 ]; then break; fi
    sleep 300
done
...
node dx.js "DOM79ENUC1.iso" --desc --truncate > desc.txt
while true; do
    python update.py ms-technet-dom79enuc1 "Microsoft TechNet DOM79ENUC1 Disc (July 2006)" desc.txt
    if [ $? -eq 0 ]; then break; fi
    sleep 300
done
...
node dx.js "DOM79ENUC2.iso" --desc --truncate > desc.txt
while true; do
    python update.py ms-technet-dom79enuc2 "Microsoft TechNet DOM79ENUC2 Disc (July 2006)" desc.txt
    if [ $? -eq 0 ]; then break; fi
    sleep 300
done
...
node dx.js "DOM80ENUC1.iso" --desc --truncate > desc.txt
while true; do
    python update.py ms-technet-dom80enuc1 "Microsoft TechNet DOM80ENUC1 Disc (August 2006)" desc.txt
    if [ $? -eq 0 ]; then break; fi
    sleep 300
done
...
node dx.js "DOM80ENUC2.iso" --desc --truncate > desc.txt
while true; do
    python update.py ms-technet-dom80enuc2 "Microsoft TechNet DOM80ENUC2 Disc (August 2006)" desc.txt
    if [ $? -eq 0 ]; then break; fi
    sleep 300
done
...
node dx.js "DOM81ENUC1.iso" --desc --truncate > desc.txt
while true; do
    python update.py ms-technet-dom81enuc1 "Microsoft TechNet DOM81ENUC1 Disc (September 2006)" desc.txt
    if [ $? -eq 0 ]; then break; fi
    sleep 300
done
...
node dx.js "DOM81ENUC2.iso" --desc --truncate > desc.txt
while true; do
    python update.py ms-technet-dom81enuc2 "Microsoft TechNet DOM81ENUC2 Disc (September 2006)" desc.txt
    if [ $? -eq 0 ]; then break; fi
    sleep 300
done
...
node dx.js "DOM82ENUC1.iso" --desc --truncate > desc.txt
while true; do
    python update.py ms-technet-dom82enuc1 "Microsoft TechNet DOM82ENUC1 Disc (October 2006)" desc.txt
    if [ $? -eq 0 ]; then break; fi
    sleep 300
done
...
node dx.js "DOM82ENUC2.iso" --desc --truncate > desc.txt
while true; do
...
node dx.js "DOM83ENUC1.iso" --desc --truncate > desc.txt
while true; do
    python update.py ms-technet-dom83enuc1 "Microsoft TechNet DOM83ENUC1 Disc (November 2006)" desc.txt
    if [ $? -eq 0 ]; then break; fi
    sleep 300
done
...
node dx.js "DOM83ENUC2.iso" --desc --truncate > desc.txt
while true; do
    python update.py ms-technet-dom83enuc2 "Microsoft TechNet DOM83ENUC2 Disc (November 2006)" desc.txt
    if [ $? -eq 0 ]; then break; fi
    sleep 300
done
...
node dx.js "DOM84ENUC1.iso" --desc --truncate > desc.txt
while true; do
    python update.py ms-technet-dom84enuc1 "Microsoft TechNet DOM84ENUC1 Disc (December 2006)" desc.txt
    if [ $? -eq 0 ]; then break; fi
    sleep 300
done
...
node dx.js "DOM84ENUC2.iso" --desc --truncate > desc.txt
while true; do
    python update.py ms-technet-dom84enuc2 "Microsoft TechNet DOM84ENUC2 Disc (December 2006)" desc.txt
    if [ $? -eq 0 ]; then break; fi
    sleep 300
done
...
node dx.js "DOM85ENUC1.iso" --desc --truncate > desc.txt
while true; do
    python update.py ms-technet-dom85enuc1 "Microsoft TechNet DOM85ENUC1 Disc (January 2007)" desc.txt
    if [ $? -eq 0 ]; then break; fi
    sleep 300
done
...
node dx.js "DOM85ENUC2.iso" --desc --truncate > desc.txt
while true; do
    python update.py ms-technet-dom85enuc2 "Microsoft TechNet DOM85ENUC2 Disc (January 2007)" desc.txt
    if [ $? -eq 0 ]; then break; fi
    sleep 300
done
...
node dx.js "DOM87ENUC1.iso" --desc --truncate > desc.txt
while true; do
    python update.py ms-technet-dom87enuc1 "Microsoft TechNet DOM87ENUC1 Disc (March 2007)" desc.txt
    if [ $? -eq 0 ]; then break; fi
    sleep 300
done
...
node dx.js "DOM87ENUC2.iso" --desc --truncate > desc.txt
while true; do
    python update.py ms-technet-dom87enuc2 "Microsoft TechNet DOM87ENUC2 Disc (March 2007)" desc.txt
    if [ $? -eq 0 ]; then break; fi
    sleep 300
done
...
node dx.js "DOM89ENUC1.iso" --desc --truncate > desc.txt
while true; do
    python update.py ms-technet-dom89enuc1 "Microsoft TechNet DOM89ENUC1 Disc (May 2007)" desc.txt
    if [ $? -eq 0 ]; then break; fi
    sleep 300
done
...
node dx.js "DOM89ENUC2.iso" --desc --truncate > desc.txt
while true; do
    python update.py ms-technet-dom89enuc2 "Microsoft TechNet DOM89ENUC2 Disc (May 2007)" desc.txt
    if [ $? -eq 0 ]; then break; fi
    sleep 300
done
...
node dx.js "DOM91ENUC1.iso" --desc --truncate > desc.txt
while true; do
    python update.py ms-technet-dom91enuc1 "Microsoft TechNet DOM91ENUC1 Disc (July 2007)" desc.txt
    if [ $? -eq 0 ]; then break; fi
    sleep 300
done
...
node dx.js "DOM91ENUC2.iso" --desc --truncate > desc.txt
while true; do
    python update.py ms-technet-dom91enuc2 "Microsoft TechNet DOM91ENUC2 Disc (July 2007)" desc.txt
    if [ $? -eq 0 ]; then break; fi
    sleep 300
done
...
node dx.js "DOM92ENUC1.iso" --desc --truncate > desc.txt
while true; do
    python update.py ms-technet-dom92enuc1 "Microsoft TechNet DOM92ENUC1 Disc (August 2007)" desc.txt
    if [ $? -eq 0 ]; then break; fi
    sleep 300
done
...
node dx.js "DOM92ENUC2.iso" --desc --truncate > desc.txt
while true; do
    python update.py ms-technet-dom92enuc2 "Microsoft TechNet DOM92ENUC2 Disc (August 2007)" desc.txt
    if [ $? -eq 0 ]; then break; fi
    sleep 300
done
...
node dx.js "EN_C0011.01.iso" --desc --truncate > desc.txt
while true; do
    python update.py ms-technet-en_c0011.01 "Microsoft TechNet EN_C0011.01 Disc (June 2007)" desc.txt
    if [ $? -eq 0 ]; then break; fi
    sleep 300
done
...
node dx.js "EN_C0358.iso" --desc --truncate > desc.txt
while true; do
    python update.py ms-technet-en_c0358 "Microsoft TechNet EN_C0358 Disc (October 2005)" desc.txt
    if [ $? -eq 0 ]; then break; fi
    sleep 300
done
...
node dx.js "EN_C0358.01.iso" --desc --truncate > desc.txt
while true; do
    python update.py ms-technet-en_c0358.01 "Microsoft TechNet EN_C0358.01 Disc (December 2005)" desc.txt
    if [ $? -eq 0 ]; then break; fi
    sleep 300
done
...
node dx.js "EN_C0363.iso" --desc --truncate > desc.txt
while true; do
    python update.py ms-technet-en_c0363 "Microsoft TechNet EN_C0363 Disc (November 2005)" desc.txt
    if [ $? -eq 0 ]; then break; fi
    sleep 300
done
...
node dx.js "EN_C0365.iso" --desc --truncate > desc.txt
while true; do
    python update.py ms-technet-en_c0365 "Microsoft TechNet EN_C0365 Disc (November 2005)" desc.txt
    if [ $? -eq 0 ]; then break; fi
    sleep 300
done
...
node dx.js "EN_C0365.01.iso" --desc --truncate > desc.txt
while true; do
    python update.py ms-technet-en_c0365.01 "Microsoft TechNet EN_C0365.01 Disc (February 2006)" desc.txt
    if [ $? -eq 0 ]; then break; fi
    sleep 300
done
...
node dx.js "EN_C0365.02.iso" --desc --truncate > desc.txt
while true; do
    python update.py ms-technet-en_c0365.02 "Microsoft TechNet EN_C0365.02 Disc (March 2006)" desc.txt
    if [ $? -eq 0 ]; then break; fi
    sleep 300
done
...
node dx.js "EN_C0388.iso" --desc --truncate > desc.txt
while true; do
    python update.py ms-technet-en_c0388 "Microsoft TechNet EN_C0388 Disc (December 2005)" desc.txt
    if [ $? -eq 0 ]; then break; fi
    sleep 300
done
...
node dx.js "EN_C0389.iso" --desc --truncate > desc.txt
while true; do
    python update.py ms-technet-en_c0389 "Microsoft TechNet EN_C0389 Disc (December 2005)" desc.txt
    if [ $? -eq 0 ]; then break; fi
    sleep 300
done
...
node dx.js "EN_C0389.01.iso" --desc --truncate > desc.txt
while true; do
    python update.py ms-technet-en_c0389.01 "Microsoft TechNet EN_C0389.01 Disc (January 2006)" desc.txt
    if [ $? -eq 0 ]; then break; fi
    sleep 300
done
...
node dx.js "EN_C0408.iso" --desc --truncate > desc.txt
while true; do
    python update.py ms-technet-en_c0408 "Microsoft TechNet EN_C0408 Disc (January 2006)" desc.txt
    if [ $? -eq 0 ]; then break; fi
    sleep 300
done
...
node dx.js "EN_C0422.01.iso" --desc --truncate > desc.txt
while true; do
    python update.py ms-technet-en_c0422.01 "Microsoft TechNet EN_C0422.01 Disc (February 2006)" desc.txt
    if [ $? -eq 0 ]; then break; fi
    sleep 300
done
...
node dx.js "EN_C0422.02.iso" --desc --truncate > desc.txt
while true; do
    python update.py ms-technet-en_c0422.02 "Microsoft TechNet EN_C0422.02 Disc (July 2006)" desc.txt
    if [ $? -eq 0 ]; then break; fi
    sleep 300
done
...
node dx.js "EN_C0422.03.iso" --desc --truncate > desc.txt
while true; do
    python update.py ms-technet-en_c0422.03 "Microsoft TechNet EN_C0422.03 Disc (August 2006)" desc.txt
    if [ $? -eq 0 ]; then break; fi
    sleep 300
done
...
node dx.js "EN_C0422.04.iso" --desc --truncate > desc.txt
while true; do
    python update.py ms-technet-en_c0422.04 "Microsoft TechNet EN_C0422.04 Disc (September 2006)" desc.txt
    if [ $? -eq 0 ]; then break; fi
    sleep 300
done
...
node dx.js "EN_C0422.05.iso" --desc --truncate > desc.txt
while true; do
    python update.py ms-technet-en_c0422.05 "Microsoft TechNet EN_C0422.05 Disc (October 2006)" desc.txt
    if [ $? -eq 0 ]; then break; fi
    sleep 300
done
...
node dx.js "EN_C0422.06.iso" --desc --truncate > desc.txt
while true; do
    python update.py ms-technet-en_c0422.06 "Microsoft TechNet EN_C0422.06 Disc (November 2006)" desc.txt
    if [ $? -eq 0 ]; then break; fi
    sleep 300
done
...
node dx.js "EN_C0454.iso" --desc --truncate > desc.txt
while true; do
    python update.py ms-technet-en_c0454 "Microsoft TechNet EN_C0454 Disc (March 2006)" desc.txt
    if [ $? -eq 0 ]; then break; fi
    sleep 300
done
...
node dx.js "EN_C0454.01.iso" --desc --truncate > desc.txt
while true; do
    python update.py ms-technet-en_c0454.01 "Microsoft TechNet EN_C0454.01 Disc (April 2006)" desc.txt
    if [ $? -eq 0 ]; then break; fi
    sleep 300
done
...
node dx.js "EN_C0454.02.iso" --desc --truncate > desc.txt
while true; do
    python update.py ms-technet-en_c0454.02 "Microsoft TechNet EN_C0454.02 Disc (May 2006)" desc.txt
    if [ $? -eq 0 ]; then break; fi
    sleep 300
done
...
node dx.js "EN_C0490.01.iso" --desc --truncate > desc.txt
while true; do
    python update.py ms-technet-en_c0490.01 "Microsoft TechNet EN_C0490.01 Disc (June 2007)" desc.txt
    if [ $? -eq 0 ]; then break; fi
    sleep 300
done
...
node dx.js "EN_C0630.iso" --desc --truncate > desc.txt
while true; do
    python update.py ms-technet-en_c0630 "Microsoft TechNet EN_C0630 Disc (April 2006)" desc.txt
    if [ $? -eq 0 ]; then break; fi
    sleep 300
done
...
node dx.js "EN_C0630.01.iso" --desc --truncate > desc.txt
while true; do
    python update.py ms-technet-en_c0630.01 "Microsoft TechNet EN_C0630.01 Disc (June 2006)" desc.txt
    if [ $? -eq 0 ]; then break; fi
    sleep 300
done
...
node dx.js "EN_C0630.03.iso" --desc --truncate > desc.txt
while true; do
    python update.py ms-technet-en_c0630.03 "Microsoft TechNet EN_C0630.03 Disc (July 2007)" desc.txt
    if [ $? -eq 0 ]; then break; fi
    sleep 300
done
...
node dx.js "EN_C0648.iso" --desc --truncate > desc.txt
while true; do
    python update.py ms-technet-en_c0648 "Microsoft TechNet EN_C0648 Disc (May 2007)" desc.txt
    if [ $? -eq 0 ]; then break; fi
    sleep 300
done
...
node dx.js "EN_C0750.01.iso" --desc --truncate > desc.txt
while true; do
    python update.py ms-technet-en_c0750.01 "Microsoft TechNet EN_C0750.01 Disc (May 2007)" desc.txt
    if [ $? -eq 0 ]; then break; fi
    sleep 300
done
...
node dx.js "EVAL_EN_0006.02.iso" --desc --truncate > desc.txt
while true; do
    python update.py ms-technet-eval_en_0006.02 "Microsoft TechNet EVAL_EN_0006.02 Disc (November 2006)" desc.txt
    if [ $? -eq 0 ]; then break; fi
    sleep 300
done
...
node dx.js "EVAL_EN_0644.iso" --desc --truncate > desc.txt
while true; do
    python update.py ms-technet-eval_en_0644 "Microsoft TechNet EVAL_EN_0644 Disc (May 2006)" desc.txt
    if [ $? -eq 0 ]; then break; fi
    sleep 300
done
...
node dx.js "EXC2000.iso" --desc --truncate > desc.txt
while true; do
    python update.py ms-technet-exc2000 "Microsoft TechNet EXC2000 Disc (November 1999)" desc.txt
    if [ $? -eq 0 ]; then break; fi
    sleep 300
done
...
node dx.js "EXPTB3EN.iso" --desc --truncate > desc.txt
while true; do
    python update.py ms-technet-exptb3en "Microsoft TechNet EXPTB3EN Disc (November 1999)" desc.txt
    if [ $? -eq 0 ]; then break; fi
    sleep 300
done
...
node dx.js "ISA2KEVLE_EN.iso" --desc --truncate > desc.txt
while true; do
    python update.py ms-technet-isa2kevle_en "Microsoft TechNet ISA2KEVLE_EN Disc (February 2004)" desc.txt
    if [ $? -eq 0 ]; then break; fi
    sleep 300
done
...
node dx.js "MSPROJECT11.iso" --desc --truncate > desc.txt
while true; do
    python update.py ms-technet-msproject11 "Microsoft TechNet MSPROJECT11 Disc (October 2003)" desc.txt
    if [ $? -eq 0 ]; then break; fi
    sleep 300
done
...
node dx.js "MSSENT04.iso" --desc --truncate > desc.txt
while true; do
    python update.py ms-technet-mssent04 "Microsoft TechNet MSSENT04 Disc (June 2004)" desc.txt
    if [ $? -eq 0 ]; then break; fi
    sleep 300
done
...
node dx.js "MSSENT04.iso" --desc --truncate > desc.txt
while true; do
    python update.py ms-technet-mssent04-1 "Microsoft TechNet MSSENT04 Disc (July 2004)" desc.txt
    if [ $? -eq 0 ]; then break; fi
    sleep 300
done
rm desc.txt MSSENT04.iso
...
node dx.js "MSSSTD04.iso" --desc --truncate > desc.txt
while true; do
    python update.py ms-technet-mssstd04 "Microsoft TechNet MSSSTD04 Disc (June 2004)" desc.txt
    if [ $? -eq 0 ]; then break; fi
    sleep 300
done
...
node dx.js "MSSSTD04.iso" --desc --truncate > desc.txt
while true; do
    python update.py ms-technet-mssstd04-1 "Microsoft TechNet MSSSTD04 Disc (July 2004)" desc.txt
    if [ $? -eq 0 ]; then break; fi
    sleep 300
done
rm desc.txt MSSSTD04.iso
...
node dx.js "NRCFRE3_EN.iso" --desc --truncate > desc.txt
while true; do
    python update.py ms-technet-nrcfre3_en "Microsoft TechNet NRCFRE3_EN Disc (August 2003)" desc.txt
    if [ $? -eq 0 ]; then break; fi
    sleep 300
done
...
node dx.js "NTOPTPAK_US.iso" --desc --truncate > desc.txt
while true; do
    python update.py ms-technet-ntoptpak_us "Microsoft TechNet NTOPTPAK_US Disc (September 1998)" desc.txt
    if [ $? -eq 0 ]; then break; fi
    sleep 300
done
...
node dx.js "OFFICE11.iso" --desc --truncate > desc.txt
while true; do
    python update.py ms-technet-office11 "Microsoft TechNet OFFICE11 Disc (August 2003)" desc.txt
    if [ $? -eq 0 ]; then break; fi
    sleep 300
done
...
node dx.js "OFFICE11.iso" --desc --truncate > desc.txt
while true; do
    python update.py ms-technet-office11-1 "Microsoft TechNet OFFICE11 Disc (October 2006)" desc.txt
    if [ $? -eq 0 ]; then break; fi
    sleep 300
done
rm desc.txt OFFICE11.iso
...
node dx.js "OFFICE11.iso" --desc --truncate > desc.txt
while true; do
    python update.py ms-technet-office11-2 "Microsoft TechNet OFFICE11 Disc (August 2005)" desc.txt
    if [ $? -eq 0 ]; then break; fi
    sleep 300
done
rm desc.txt OFFICE11.iso
...
node dx.js "OFFICE11.iso" --desc --truncate > desc.txt
while true; do
    python update.py ms-technet-office11-3 "Microsoft TechNet OFFICE11 Disc (January 2006)" desc.txt
    if [ $? -eq 0 ]; then break; fi
    sleep 300
done
rm desc.txt OFFICE11.iso
...
node dx.js "OFFICE11.iso" --desc --truncate > desc.txt
while true; do
    python update.py ms-technet-office11-4 "Microsoft TechNet OFFICE11 Disc (August 2005)" desc.txt
    if [ $? -eq 0 ]; then break; fi
    sleep 300
done
rm desc.txt OFFICE11.iso
...
node dx.js "OFFICE11.iso" --desc --truncate > desc.txt
while true; do
    python update.py ms-technet-office11-5 "Microsoft TechNet OFFICE11 Disc (September 2005)" desc.txt
    if [ $? -eq 0 ]; then break; fi
    sleep 300
done
rm desc.txt OFFICE11.iso
...
node dx.js "OFFICE11.iso" --desc --truncate > desc.txt
while true; do
    python update.py ms-technet-office11-6 "Microsoft TechNet OFFICE11 Disc (August 2007)" desc.txt
    if [ $? -eq 0 ]; then break; fi
    sleep 300
done
rm desc.txt OFFICE11.iso
...
node dx.js "OFFICE12.iso" --desc --truncate > desc.txt
while true; do
    python update.py ms-technet-office12 "Microsoft TechNet OFFICE12 Disc (January 2007)" desc.txt
    if [ $? -eq 0 ]; then break; fi
    sleep 300
done
...
node dx.js "OFFICE12.iso" --desc --truncate > desc.txt
while true; do
    python update.py ms-technet-office12-1 "Microsoft TechNet OFFICE12 Disc (January 2007)" desc.txt
    if [ $? -eq 0 ]; then break; fi
    sleep 300
done
rm desc.txt OFFICE12.iso
...
node dx.js "OFFICE12.iso" --desc --truncate > desc.txt
while true; do
    python update.py ms-technet-office12-2 "Microsoft TechNet OFFICE12 Disc (January 2007)" desc.txt
    if [ $? -eq 0 ]; then break; fi
    sleep 300
done
rm desc.txt OFFICE12.iso
...
node dx.js "OFFICE12.iso" --desc --truncate > desc.txt
while true; do
    python update.py ms-technet-office12-3 "Microsoft TechNet OFFICE12 Disc (June 2007)" desc.txt
    if [ $? -eq 0 ]; then break; fi
    sleep 300
done
rm desc.txt OFFICE12.iso
...
node dx.js "OFFICE12.iso" --desc --truncate > desc.txt
while true; do
    python update.py ms-technet-office12-4 "Microsoft TechNet OFFICE12 Disc (January 2007)" desc.txt
    if [ $? -eq 0 ]; then break; fi
    sleep 300
done
rm desc.txt OFFICE12.iso
...
node dx.js "PD002CD1.iso" --desc --truncate > desc.txt
while true; do
    python update.py ms-technet-pd002cd1 "Microsoft TechNet PD002CD1 Disc (August 1999)" desc.txt
    if [ $? -eq 0 ]; then break; fi
    sleep 300
done
...
node dx.js "PD002CD2.iso" --desc --truncate > desc.txt
while true; do
    python update.py ms-technet-pd002cd2 "Microsoft TechNet PD002CD2 Disc (August 1999)" desc.txt
    if [ $? -eq 0 ]; then break; fi
    sleep 300
done
...
node dx.js "PD002CD3.iso" --desc --truncate > desc.txt
while true; do
    python update.py ms-technet-pd002cd3 "Microsoft TechNet PD002CD3 Disc (August 1999)" desc.txt
    if [ $? -eq 0 ]; then break; fi
    sleep 300
done
...
node dx.js "PREMTECH.iso" --desc --truncate > desc.txt
while true; do
    python update.py ms-technet-premtech "Microsoft TechNet PREMTECH Disc (August 2003)" desc.txt
    if [ $? -eq 0 ]; then break; fi
    sleep 300
done
...
node dx.js "SB0CD003.iso" --desc --truncate > desc.txt
while true; do
    python update.py ms-technet-sb0cd003 "Microsoft TechNet SB0CD003 Disc (February 2004)" desc.txt
    if [ $? -eq 0 ]; then break; fi
    sleep 300
done
...
node dx.js "SB0CD003.iso" --desc --truncate > desc.txt
while true; do
    python update.py ms-technet-sb0cd003-1 "Microsoft TechNet SB0CD003 Disc (March 2004)" desc.txt
    if [ $? -eq 0 ]; then break; fi
    sleep 300
done
rm desc.txt SB0CD003.iso
...
node dx.js "SB0CD003.iso" --desc --truncate > desc.txt
while true; do
    python update.py ms-technet-sb0cd003-2 "Microsoft TechNet SB0CD003 Disc (April 2004)" desc.txt
    if [ $? -eq 0 ]; then break; fi
    sleep 300
done
rm desc.txt SB0CD003.iso
...
node dx.js "SB0CD003.iso" --desc --truncate > desc.txt
while true; do
    python update.py ms-technet-sb0cd003-3 "Microsoft TechNet SB0CD003 Disc (May 2004)" desc.txt
    if [ $? -eq 0 ]; then break; fi
    sleep 300
done
rm desc.txt SB0CD003.iso
...
node dx.js "SB0CD003.iso" --desc --truncate > desc.txt
while true; do
    python update.py ms-technet-sb0cd003-4 "Microsoft TechNet SB0CD003 Disc (June 2004)" desc.txt
    if [ $? -eq 0 ]; then break; fi
    sleep 300
done
rm desc.txt SB0CD003.iso
...
node dx.js "SB0CD003.iso" --desc --truncate > desc.txt
while true; do
    python update.py ms-technet-sb0cd003-5 "Microsoft TechNet SB0CD003 Disc (July 2004)" desc.txt
    if [ $? -eq 0 ]; then break; fi
    sleep 300
done
rm desc.txt SB0CD003.iso
...
node dx.js "SB0CD003.iso" --desc --truncate > desc.txt
while true; do
    python update.py ms-technet-sb0cd003-6 "Microsoft TechNet SB0CD003 Disc (August 2004)" desc.txt
    if [ $? -eq 0 ]; then break; fi
    sleep 300
done
rm desc.txt SB0CD003.iso
...
node dx.js "SB0CD003.iso" --desc --truncate > desc.txt
while true; do
    python update.py ms-technet-sb0cd003-7 "Microsoft TechNet SB0CD003 Disc (September 2004)" desc.txt
    if [ $? -eq 0 ]; then break; fi
    sleep 300
done
rm desc.txt SB0CD003.iso
...
node dx.js "SB0CD005.03.iso" --desc --truncate > desc.txt
while true; do
    python update.py ms-technet-sb0cd005.03 "Microsoft TechNet SB0CD005.03 Disc (August 2005)" desc.txt
    if [ $? -eq 0 ]; then break; fi
    sleep 300
done
...
node dx.js "SB0CD005.04.iso" --desc --truncate > desc.txt
while true; do
    python update.py ms-technet-sb0cd005.04 "Microsoft TechNet SB0CD005.04 Disc (September 2005)" desc.txt
    if [ $? -eq 0 ]; then break; fi
    sleep 300
done
...
node dx.js "SB0CD006.iso" --desc --truncate > desc.txt
while true; do
    python update.py ms-technet-sb0cd006 "Microsoft TechNet SB0CD006 Disc (December 2005)" desc.txt
    if [ $? -eq 0 ]; then break; fi
    sleep 300
done
...
node dx.js "SB0CD006.01.iso" --desc --truncate > desc.txt
while true; do
    python update.py ms-technet-sb0cd006.01 "Microsoft TechNet SB0CD006.01 Disc (January 2006)" desc.txt
    if [ $? -eq 0 ]; then break; fi
    sleep 300
done
...
node dx.js "SB0CD006.02.iso" --desc --truncate > desc.txt
while true; do
    python update.py ms-technet-sb0cd006.02 "Microsoft TechNet SB0CD006.02 Disc (February 2006)" desc.txt
    if [ $? -eq 0 ]; then break; fi
    sleep 300
done
...
node dx.js "SB0CD006.03.iso" --desc --truncate > desc.txt
while true; do
    python update.py ms-technet-sb0cd006.03 "Microsoft TechNet SB0CD006.03 Disc (March 2006)" desc.txt
    if [ $? -eq 0 ]; then break; fi
    sleep 300
done
...
node dx.js "SB0CD006.04.iso" --desc --truncate > desc.txt
while true; do
    python update.py ms-technet-sb0cd006.04 "Microsoft TechNet SB0CD006.04 Disc (April 2006)" desc.txt
    if [ $? -eq 0 ]; then break; fi
    sleep 300
done
...
node dx.js "SB0CD007.iso" --desc --truncate > desc.txt
while true; do
    python update.py ms-technet-sb0cd007 "Microsoft TechNet SB0CD007 Disc (May 2006)" desc.txt
    if [ $? -eq 0 ]; then break; fi
    sleep 300
done
...
node dx.js "SB0CD007.01.iso" --desc --truncate > desc.txt
while true; do
    python update.py ms-technet-sb0cd007.01 "Microsoft TechNet SB0CD007.01 Disc (June 2006)" desc.txt
    if [ $? -eq 0 ]; then break; fi
    sleep 300
done
...
node dx.js "SB0CD007.02.iso" --desc --truncate > desc.txt
while true; do
    python update.py ms-technet-sb0cd007.02 "Microsoft TechNet SB0CD007.02 Disc (July 2006)" desc.txt
    if [ $? -eq 0 ]; then break; fi
    sleep 300
done
...
node dx.js "SB0CD007.03.iso" --desc --truncate > desc.txt
while true; do
    python update.py ms-technet-sb0cd007.03 "Microsoft TechNet SB0CD007.03 Disc (August 2006)" desc.txt
    if [ $? -eq 0 ]; then break; fi
    sleep 300
done
...
node dx.js "SB0CD008.iso" --desc --truncate > desc.txt
while true; do
    python update.py ms-technet-sb0cd008 "Microsoft TechNet SB0CD008 Disc (October 2006)" desc.txt
    if [ $? -eq 0 ]; then break; fi
    sleep 300
done
...
node dx.js "SB0CD008.01.iso" --desc --truncate > desc.txt
while true; do
    python update.py ms-technet-sb0cd008.01 "Microsoft TechNet SB0CD008.01 Disc (November 2006)" desc.txt
    if [ $? -eq 0 ]; then break; fi
    sleep 300
done
...
node dx.js "SB0CD008.02.iso" --desc --truncate > desc.txt
while true; do
    python update.py ms-technet-sb0cd008.02 "Microsoft TechNet SB0CD008.02 Disc (December 2006)" desc.txt
    if [ $? -eq 0 ]; then break; fi
    sleep 300
done
...
node dx.js "SB0CD010.01.iso" --desc --truncate > desc.txt
while true; do
    python update.py ms-technet-sb0cd010.01 "Microsoft TechNet SB0CD010.01 Disc (June 2007)" desc.txt
    if [ $? -eq 0 ]; then break; fi
    sleep 300
done
...
node dx.js "SB0CD011.01.iso" --desc --truncate > desc.txt
while true; do
    python update.py ms-technet-sb0cd011.01 "Microsoft TechNet SB0CD011.01 Disc (August 2007)" desc.txt
    if [ $? -eq 0 ]; then break; fi
    sleep 300
done
...
node dx.js "SB4CD038.iso" --desc --truncate > desc.txt
while true; do
    python update.py ms-technet-sb4cd038 "Microsoft TechNet SB4CD038 Disc (January 2007)" desc.txt
    if [ $? -eq 0 ]; then break; fi
    sleep 300
done
...
node dx.js "SBS0CD011.iso" --desc --truncate > desc.txt
while true; do
    python update.py ms-technet-sbs0cd011 "Microsoft TechNet SBS0CD011 Disc (July 2007)" desc.txt
    if [ $? -eq 0 ]; then break; fi
    sleep 300
done
...
node dx.js "SCCP.iso" --desc --truncate > desc.txt
while true; do
    python update.py ms-technet-sccp "Microsoft TechNet SCCP Disc (January 2006)" desc.txt
    if [ $? -eq 0 ]; then break; fi
    sleep 300
done
...
node dx.js "SOFTLIB.iso" --desc --truncate > desc.txt
while true; do
    python update.py ms-technet-softlib "Microsoft TechNet SOFTLIB Disc (June 1997)" desc.txt
    if [ $? -eq 0 ]; then break; fi
    sleep 300
done
...
node dx.js "SQL2000RS_EVAL.iso" --desc --truncate > desc.txt
while true; do
    python update.py ms-technet-sql2000rs_eval "Microsoft TechNet SQL2000RS_EVAL Disc (March 2004)" desc.txt
    if [ $? -eq 0 ]; then break; fi
    sleep 300
done
...
node dx.js "SQL2005_CTP_EN_0223.02.iso" --desc --truncate > desc.txt
while true; do
    python update.py ms-technet-sql2005_ctp_en_0223.02 "Microsoft TechNet SQL2005_CTP_EN_0223.02 Disc (August 2005)" desc.txt
    if [ $? -eq 0 ]; then break; fi
    sleep 300
done
...
node dx.js "SQL2005_CTP_EN_0223.03.iso" --desc --truncate > desc.txt
while true; do
    python update.py ms-technet-sql2005_ctp_en_0223.03 "Microsoft TechNet SQL2005_CTP_EN_0223.03 Disc (September 2005)" desc.txt
    if [ $? -eq 0 ]; then break; fi
    sleep 300
done
...
node dx.js "SQL2005_CTP_EN_0223.04.iso" --desc --truncate > desc.txt
while true; do
    python update.py ms-technet-sql2005_ctp_en_0223.04 "Microsoft TechNet SQL2005_CTP_EN_0223.04 Disc (October 2005)" desc.txt
    if [ $? -eq 0 ]; then break; fi
    sleep 300
done
...
node dx.js "SQLSRVRS.iso" --desc --truncate > desc.txt
while true; do
    python update.py ms-technet-sqlsrvrs "Microsoft TechNet SQLSRVRS Disc (December 2005)" desc.txt
    if [ $? -eq 0 ]; then break; fi
    sleep 300
done
...
node dx.js "SQLSRVRS.iso" --desc --truncate > desc.txt
while true; do
    python update.py ms-technet-sqlsrvrs-1 "Microsoft TechNet SQLSRVRS Disc (December 2005)" desc.txt
    if [ $? -eq 0 ]; then break; fi
    sleep 300
done
rm desc.txt SQLSRVRS.iso
...
node dx.js "SQLTOOLS.iso" --desc --truncate > desc.txt
while true; do
    python update.py ms-technet-sqltools "Microsoft TechNet SQLTOOLS Disc (December 2005)" desc.txt
    if [ $? -eq 0 ]; then break; fi
    sleep 300
done
...
node dx.js "SQLTOOLS.iso" --desc --truncate > desc.txt
while true; do
    python update.py ms-technet-sqltools-1 "Microsoft TechNet SQLTOOLS Disc (December 2005)" desc.txt
    if [ $? -eq 0 ]; then break; fi
    sleep 300
done
rm desc.txt SQLTOOLS.iso
...
node dx.js "SQLWKGPX86.iso" --desc --truncate > desc.txt
while true; do
    python update.py ms-technet-sqlwkgpx86 "Microsoft TechNet SQLWKGPX86 Disc (August 2005)" desc.txt
    if [ $? -eq 0 ]; then break; fi
    sleep 300
done
...
node dx.js "SRK41.iso" --desc --truncate > desc.txt
while true; do
    python update.py ms-technet-srk41 "Microsoft TechNet SRK41 Disc (October 2003)" desc.txt
    if [ $? -eq 0 ]; then break; fi
    sleep 300
done
...
node dx.js "TECHNET_INDEX_1005.iso" --desc --truncate > desc.txt
while true; do
    python update.py ms-technet-technet_index_1005 "Microsoft TechNet TECHNET_INDEX_1005 Disc (October 2005)" desc.txt
    if [ $? -eq 0 ]; then break; fi
    sleep 300
done
...
node dx.js "TECHNET_INDEX_2005-08.iso" --desc --truncate > desc.txt
while true; do
    python update.py ms-technet-technet_index_2005-08 "Microsoft TechNet TECHNET_INDEX_2005-08 Disc (September 2005)" desc.txt
    if [ $? -eq 0 ]; then break; fi
    sleep 300
done
...
node dx.js "TN00403C.iso" --desc --truncate > desc.txt
while true; do
    python update.py ms-technet-tn00403c "Microsoft TechNet TN00403C Disc (March 2004)" desc.txt
    if [ $? -eq 0 ]; then break; fi
    sleep 300
done
...
node dx.js "TN00404C.iso" --desc --truncate > desc.txt
while true; do
    python update.py ms-technet-tn00404c "Microsoft TechNet TN00404C Disc (April 2004)" desc.txt
    if [ $? -eq 0 ]; then break; fi
    sleep 300
done
...
node dx.js "TN0211A.iso" --desc --truncate > desc.txt
while true; do
    python update.py ms-technet-tn0211a "Microsoft TechNet TN0211A Disc (November 2002)" desc.txt
    if [ $? -eq 0 ]; then break; fi
    sleep 300
done
...
node dx.js "TN0310A.iso" --desc --truncate > desc.txt
while true; do
    python update.py ms-technet-tn0310a "Microsoft TechNet TN0310A Disc (October 2003)" desc.txt
    if [ $? -eq 0 ]; then break; fi
    sleep 300
done
...
node dx.js "TN0312A.iso" --desc --truncate > desc.txt
while true; do
    python update.py ms-technet-tn0312a "Microsoft TechNet TN0312A Disc (December 2003)" desc.txt
    if [ $? -eq 0 ]; then break; fi
    sleep 300
done
...
node dx.js "TN9711.iso" --desc --truncate > desc.txt
while true; do
    python update.py ms-technet-tn9711 "Microsoft TechNet TN9711 Disc (November 1997)" desc.txt
    if [ $? -eq 0 ]; then break; fi
    sleep 300
done
...
node dx.js "TN9809.iso" --desc --truncate > desc.txt
while true; do
    python update.py ms-technet-tn9809 "Microsoft TechNet TN9809 Disc (September 1998)" desc.txt
    if [ $? -eq 0 ]; then break; fi
    sleep 300
done
...
node dx.js "TN9908.iso" --desc --truncate > desc.txt
while true; do
    python update.py ms-technet-tn9908 "Microsoft TechNet TN9908 Disc (August 1999)" desc.txt
    if [ $? -eq 0 ]; then break; fi
    sleep 300
done
...
node dx.js "TN9911.iso" --desc --truncate > desc.txt
while true; do
    python update.py ms-technet-tn9911 "Microsoft TechNet TN9911 Disc (November 1999)" desc.txt
    if [ $? -eq 0 ]; then break; fi
    sleep 300
done
...
node dx.js "TNA9709.iso" --desc --truncate > desc.txt
while true; do
    python update.py ms-technet-tna9709 "Microsoft TechNet TNA9709 Disc (September 1997)" desc.txt
    if [ $? -eq 0 ]; then break; fi
    sleep 300
done
...
node dx.js "TNB9709.iso" --desc --truncate > desc.txt
while true; do
    python update.py ms-technet-tnb9709 "Microsoft TechNet TNB9709 Disc (September 1997)" desc.txt
    if [ $? -eq 0 ]; then break; fi
    sleep 300
done
...
node dx.js "TNB9711.iso" --desc --truncate > desc.txt
while true; do
    python update.py ms-technet-tnb9711 "Microsoft TechNet TNB9711 Disc (November 1997)" desc.txt
    if [ $? -eq 0 ]; then break; fi
    sleep 300
done
...
node dx.js "TNB9809.iso" --desc --truncate > desc.txt
while true; do
    python update.py ms-technet-tnb9809 "Microsoft TechNet TNB9809 Disc (September 1998)" desc.txt
    if [ $? -eq 0 ]; then break; fi
    sleep 300
done
...
node dx.js "TNB9908.iso" --desc --truncate > desc.txt
while true; do
    python update.py ms-technet-tnb9908 "Microsoft TechNet TNB9908 Disc (August 1999)" desc.txt
    if [ $? -eq 0 ]; then break; fi
    sleep 300
done
...
node dx.js "TNCD1-9701.iso" --desc --truncate > desc.txt
while true; do
    python update.py ms-technet-tncd1-9701 "Microsoft TechNet TNCD1-9701 Disc (January 1997)" desc.txt
    if [ $? -eq 0 ]; then break; fi
    sleep 300
done
...
node dx.js "TNCD2-9701.iso" --desc --truncate > desc.txt
while true; do
    python update.py ms-technet-tncd2-9701 "Microsoft TechNet TNCD2-9701 Disc (January 1997)" desc.txt
    if [ $? -eq 0 ]; then break; fi
    sleep 300
done
...
node dx.js "TNET9602.iso" --desc --truncate > desc.txt
while true; do
    python update.py ms-technet-tnet9602 "Microsoft TechNet TNET9602 Disc (February 1996)" desc.txt
    if [ $? -eq 0 ]; then break; fi
    sleep 300
done
...
node dx.js "TNET9604.iso" --desc --truncate > desc.txt
while true; do
    python update.py ms-technet-tnet9604 "Microsoft TechNet TNET9604 Disc (April 1996)" desc.txt
    if [ $? -eq 0 ]; then break; fi
    sleep 300
done
...
node dx.js "TNI9602.iso" --desc --truncate > desc.txt
while true; do
    python update.py ms-technet-tni9602 "Microsoft TechNet TNI9602 Disc (February 1996)" desc.txt
    if [ $? -eq 0 ]; then break; fi
    sleep 300
done
...
node dx.js "TNK9809.iso" --desc --truncate > desc.txt
while true; do
    python update.py ms-technet-tnk9809 "Microsoft TechNet TNK9809 Disc (September 1998)" desc.txt
    if [ $? -eq 0 ]; then break; fi
    sleep 300
done
...
node dx.js "TNK9810.iso" --desc --truncate > desc.txt
while true; do
    python update.py ms-technet-tnk9810 "Microsoft TechNet TNK9810 Disc (October 1998)" desc.txt
    if [ $? -eq 0 ]; then break; fi
    sleep 300
done
...
node dx.js "TNK9908.iso" --desc --truncate > desc.txt
while true; do
    python update.py ms-technet-tnk9908 "Microsoft TechNet TNK9908 Disc (August 1999)" desc.txt
    if [ $? -eq 0 ]; then break; fi
    sleep 300
done
...
node dx.js "TNK9909.iso" --desc --truncate > desc.txt
while true; do
    python update.py ms-technet-tnk9909 "Microsoft TechNet TNK9909 Disc (September 1999)" desc.txt
    if [ $? -eq 0 ]; then break; fi
    sleep 300
done
...
node dx.js "TNSA9809.iso" --desc --truncate > desc.txt
while true; do
    python update.py ms-technet-tnsa9809 "Microsoft TechNet TNSA9809 Disc (September 1998)" desc.txt
    if [ $? -eq 0 ]; then break; fi
    sleep 300
done
...
node dx.js "TNSB9809.iso" --desc --truncate > desc.txt
while true; do
    python update.py ms-technet-tnsb9809 "Microsoft TechNet TNSB9809 Disc (September 1998)" desc.txt
    if [ $? -eq 0 ]; then break; fi
    sleep 300
done
...
node dx.js "TNSB9908.iso" --desc --truncate > desc.txt
while true; do
    python update.py ms-technet-tnsb9908 "Microsoft TechNet TNSB9908 Disc (August 1999)" desc.txt
    if [ $? -eq 0 ]; then break; fi
    sleep 300
done
...
node dx.js "TNSC9710.iso" --desc --truncate > desc.txt
while true; do
    python update.py ms-technet-tnsc9710 "Microsoft TechNet TNSC9710 Disc (October 1997)" desc.txt
    if [ $? -eq 0 ]; then break; fi
    sleep 300
done
...
node dx.js "TNSC9809.iso" --desc --truncate > desc.txt
while true; do
    python update.py ms-technet-tnsc9809 "Microsoft TechNet TNSC9809 Disc (September 1998)" desc.txt
    if [ $? -eq 0 ]; then break; fi
    sleep 300
done
...
node dx.js "TNSC9901.iso" --desc --truncate > desc.txt
while true; do
    python update.py ms-technet-tnsc9901 "Microsoft TechNet TNSC9901 Disc (January 1999)" desc.txt
    if [ $? -eq 0 ]; then break; fi
    sleep 300
done
...
node dx.js "TNSE9809.iso" --desc --truncate > desc.txt
while true; do
    python update.py ms-technet-tnse9809 "Microsoft TechNet TNSE9809 Disc (September 1998)" desc.txt
    if [ $? -eq 0 ]; then break; fi
    sleep 300
done
...
node dx.js "TNSF9809.iso" --desc --truncate > desc.txt
while true; do
    python update.py ms-technet-tnsf9809 "Microsoft TechNet TNSF9809 Disc (September 1998)" desc.txt
    if [ $? -eq 0 ]; then break; fi
    sleep 300
done
...
node dx.js "TNSG9809.iso" --desc --truncate > desc.txt
while true; do
    python update.py ms-technet-tnsg9809 "Microsoft TechNet TNSG9809 Disc (September 1998)" desc.txt
    if [ $? -eq 0 ]; then break; fi
    sleep 300
done
...
node dx.js "TNUA9809.iso" --desc --truncate > desc.txt
while true; do
    python update.py ms-technet-tnua9809 "Microsoft TechNet TNUA9809 Disc (September 1998)" desc.txt
    if [ $? -eq 0 ]; then break; fi
    sleep 300
done
...
node dx.js "TNUB9809.iso" --desc --truncate > desc.txt
while true; do
    python update.py ms-technet-tnub9809 "Microsoft TechNet TNUB9809 Disc (September 1998)" desc.txt
    if [ $? -eq 0 ]; then break; fi
    sleep 300
done
...
node dx.js "TNUC9809.iso" --desc --truncate > desc.txt
while true; do
    python update.py ms-technet-tnuc9809 "Microsoft TechNet TNUC9809 Disc (September 1998)" desc.txt
    if [ $? -eq 0 ]; then break; fi
    sleep 300
done
...
node dx.js "TNUC9908.iso" --desc --truncate > desc.txt
while true; do
    python update.py ms-technet-tnuc9908 "Microsoft TechNet TNUC9908 Disc (August 1999)" desc.txt
    if [ $? -eq 0 ]; then break; fi
    sleep 300
done
...
node dx.js "TNUD9809.iso" --desc --truncate > desc.txt
while true; do
    python update.py ms-technet-tnud9809 "Microsoft TechNet TNUD9809 Disc (September 1998)" desc.txt
    if [ $? -eq 0 ]; then break; fi
    sleep 300
done
...
node dx.js "TNUF9809.iso" --desc --truncate > desc.txt
while true; do
    python update.py ms-technet-tnuf9809 "Microsoft TechNet TNUF9809 Disc (September 1998)" desc.txt
    if [ $? -eq 0 ]; then break; fi
    sleep 300
done
...
node dx.js "TN_INDEX_0511.iso" --desc --truncate > desc.txt
while true; do
    python update.py ms-technet-tn_index_0511 "Microsoft TechNet TN_INDEX_0511 Disc (November 2005)" desc.txt
    if [ $? -eq 0 ]; then break; fi
    sleep 300
done
...
node dx.js "TN_INDEX_0512.iso" --desc --truncate > desc.txt
while true; do
    python update.py ms-technet-tn_index_0512 "Microsoft TechNet TN_INDEX_0512 Disc (December 2005)" desc.txt
    if [ $? -eq 0 ]; then break; fi
    sleep 300
done
...
node dx.js "TN_INDEX_0601.iso" --desc --truncate > desc.txt
while true; do
    python update.py ms-technet-tn_index_0601 "Microsoft TechNet TN_INDEX_0601 Disc (January 2006)" desc.txt
    if [ $? -eq 0 ]; then break; fi
    sleep 300
done
...
node dx.js "TN_INDEX_0602.iso" --desc --truncate > desc.txt
while true; do
    python update.py ms-technet-tn_index_0602 "Microsoft TechNet TN_INDEX_0602 Disc (February 2006)" desc.txt
    if [ $? -eq 0 ]; then break; fi
    sleep 300
done
...
node dx.js "TN_INDEX_0603.iso" --desc --truncate > desc.txt
while true; do
    python update.py ms-technet-tn_index_0603 "Microsoft TechNet TN_INDEX_0603 Disc (March 2006)" desc.txt
    if [ $? -eq 0 ]; then break; fi
    sleep 300
done
...
node dx.js "TN_INDEX_0604.iso" --desc --truncate > desc.txt
while true; do
    python update.py ms-technet-tn_index_0604 "Microsoft TechNet TN_INDEX_0604 Disc (April 2006)" desc.txt
    if [ $? -eq 0 ]; then break; fi
    sleep 300
done
...
node dx.js "TN_INDEX_0605.iso" --desc --truncate > desc.txt
while true; do
    python update.py ms-technet-tn_index_0605 "Microsoft TechNet TN_INDEX_0605 Disc (May 2006)" desc.txt
    if [ $? -eq 0 ]; then break; fi
    sleep 300
done
...
node dx.js "TN_INDEX_0606.iso" --desc --truncate > desc.txt
while true; do
    python update.py ms-technet-tn_index_0606 "Microsoft TechNet TN_INDEX_0606 Disc (June 2006)" desc.txt
    if [ $? -eq 0 ]; then break; fi
    sleep 300
done
...
node dx.js "TN_INDEX_0607.iso" --desc --truncate > desc.txt
while true; do
    python update.py ms-technet-tn_index_0607 "Microsoft TechNet TN_INDEX_0607 Disc (July 2006)" desc.txt
    if [ $? -eq 0 ]; then break; fi
    sleep 300
done
...
node dx.js "TN_INDEX_0608.iso" --desc --truncate > desc.txt
while true; do
    python update.py ms-technet-tn_index_0608 "Microsoft TechNet TN_INDEX_0608 Disc (August 2006)" desc.txt
    if [ $? -eq 0 ]; then break; fi
    sleep 300
done
...
node dx.js "TN_INDEX_0609.iso" --desc --truncate > desc.txt
while true; do
    python update.py ms-technet-tn_index_0609 "Microsoft TechNet TN_INDEX_0609 Disc (September 2006)" desc.txt
    if [ $? -eq 0 ]; then break; fi
    sleep 300
done
...
node dx.js "TN_INDEX_0610.iso" --desc --truncate > desc.txt
while true; do
    python update.py ms-technet-tn_index_0610 "Microsoft TechNet TN_INDEX_0610 Disc (October 2006)" desc.txt
    if [ $? -eq 0 ]; then break; fi
    sleep 300
done
...
node dx.js "TN_INDEX_0611.iso" --desc --truncate > desc.txt
while true; do
    python update.py ms-technet-tn_index_0611 "Microsoft TechNet TN_INDEX_0611 Disc (November 2006)" desc.txt
    if [ $? -eq 0 ]; then break; fi
    sleep 300
done
...
node dx.js "TN_INDEX_0612.iso" --desc --truncate > desc.txt
while true; do
    python update.py ms-technet-tn_index_0612 "Microsoft TechNet TN_INDEX_0612 Disc (December 2006)" desc.txt
    if [ $? -eq 0 ]; then break; fi
    sleep 300
done
...
node dx.js "TN_INDEX_0701.iso" --desc --truncate > desc.txt
while true; do
    python update.py ms-technet-tn_index_0701 "Microsoft TechNet TN_INDEX_0701 Disc (January 2007)" desc.txt
    if [ $? -eq 0 ]; then break; fi
    sleep 300
done
...
node dx.js "TN_INDEX_0703.iso" --desc --truncate > desc.txt
while true; do
    python update.py ms-technet-tn_index_0703 "Microsoft TechNet TN_INDEX_0703 Disc (March 2007)" desc.txt
    if [ $? -eq 0 ]; then break; fi
    sleep 300
done
...
node dx.js "TN_INDEX_0707.iso" --desc --truncate > desc.txt
while true; do
    python update.py ms-technet-tn_index_0707 "Microsoft TechNet TN_INDEX_0707 Disc (July 2007)" desc.txt
    if [ $? -eq 0 ]; then break; fi
    sleep 300
done
...
node dx.js "TN_INDEX_0708.iso" --desc --truncate > desc.txt
while true; do
    python update.py ms-technet-tn_index_0708 "Microsoft TechNet TN_INDEX_0708 Disc (August 2007)" desc.txt
    if [ $? -eq 0 ]; then break; fi
    sleep 300
done
...
node dx.js "TN_INDEX_0712.iso" --desc --truncate > desc.txt
while true; do
    python update.py ms-technet-tn_index_0712 "Microsoft TechNet TN_INDEX_0712 Disc (December 2007)" desc.txt
    if [ $? -eq 0 ]; then break; fi
    sleep 300
done
...
node dx.js "TTCD_JAN06.iso" --desc --truncate > desc.txt
while true; do
    python update.py ms-technet-ttcd_jan06 "Microsoft TechNet TTCD_JAN06 Disc (January 2006)" desc.txt
    if [ $? -eq 0 ]; then break; fi
    sleep 300
done
...
node dx.js "TTCD_JAN07.iso" --desc --truncate > desc.txt
while true; do
    python update.py ms-technet-ttcd_jan07 "Microsoft TechNet TTCD_JAN07 Disc (January 2007)" desc.txt
    if [ $? -eq 0 ]; then break; fi
    sleep 300
done
...
node dx.js "TTCD_JUL06.iso" --desc --truncate > desc.txt
while true; do
    python update.py ms-technet-ttcd_jul06 "Microsoft TechNet TTCD_JUL06 Disc (July 2006)" desc.txt
    if [ $? -eq 0 ]; then break; fi
    sleep 300
done
...
node dx.js "TTCD_OCT06.iso" --desc --truncate > desc.txt
while true; do
    python update.py ms-technet-ttcd_oct06 "Microsoft TechNet TTCD_OCT06 Disc (October 2006)" desc.txt
    if [ $? -eq 0 ]; then break; fi
    sleep 300
done
...
node dx.js "TTCD_OCT07.iso" --desc --truncate > desc.txt
while true; do
    python update.py ms-technet-ttcd_oct07 "Microsoft TechNet TTCD_OCT07 Disc (October 2007)" desc.txt
    if [ $? -eq 0 ]; then break; fi
    sleep 300
done
...
node dx.js "TTCD_OCT2005.iso" --desc --truncate > desc.txt
while true; do
    python update.py ms-technet-ttcd_oct2005 "Microsoft TechNet TTCD_OCT2005 Disc (October 2005)" desc.txt
    if [ $? -eq 0 ]; then break; fi
    sleep 300
done
...
node dx.js "TTT25.iso" --desc --truncate > desc.txt
while true; do
    python update.py ms-technet-ttt25 "Microsoft TechNet TTT25 Disc (October 2003)" desc.txt
    if [ $? -eq 0 ]; then break; fi
    sleep 300
done
...
node dx.js "TTT26.iso" --desc --truncate > desc.txt
while true; do
    python update.py ms-technet-ttt26 "Microsoft TechNet TTT26 Disc (January 2004)" desc.txt
    if [ $? -eq 0 ]; then break; fi
    sleep 300
done
...
node dx.js "TTT27.iso" --desc --truncate > desc.txt
while true; do
    python update.py ms-technet-ttt27 "Microsoft TechNet TTT27 Disc (April 2004)" desc.txt
    if [ $? -eq 0 ]; then break; fi
    sleep 300
done
...
node dx.js "TTT28.iso" --desc --truncate > desc.txt
while true; do
    python update.py ms-technet-ttt28 "Microsoft TechNet TTT28 Disc (July 2004)" desc.txt
    if [ $? -eq 0 ]; then break; fi
    sleep 300
done
...
node dx.js "TTT28.iso" --desc --truncate > desc.txt
while true; do
    python update.py ms-technet-ttt28-1 "Microsoft TechNet TTT28 Disc (April 2004)" desc.txt
    if [ $? -eq 0 ]; then break; fi
    sleep 300
done
rm desc.txt TTT28.iso
...
node dx.js "UTILITY1.iso" --desc --truncate > desc.txt
while true; do
    python update.py ms-technet-utility1 "Microsoft TechNet UTILITY1 Disc (November 1999)" desc.txt
    if [ $? -eq 0 ]; then break; fi
    sleep 300
done
...
node dx.js "VISIO_STD_2002.iso" --desc --truncate > desc.txt
while true; do
    python update.py ms-technet-visio_std_2002 "Microsoft TechNet VISIO_STD_2002 Disc (October 2003)" desc.txt
    if [ $? -eq 0 ]; then break; fi
    sleep 300
done
...
node dx.js "W2KASVA_USA.iso" --desc --truncate > desc.txt
while true; do
    python update.py ms-technet-w2kasva_usa "Microsoft TechNet W2KASVA_USA Disc (August 1999)" desc.txt
    if [ $? -eq 0 ]; then break; fi
    sleep 300
done
...
node dx.js "W2KASVI_USA.iso" --desc --truncate > desc.txt
while true; do
    python update.py ms-technet-w2kasvi_usa "Microsoft TechNet W2KASVI_USA Disc (August 1999)" desc.txt
    if [ $? -eq 0 ]; then break; fi
    sleep 300
done
...
node dx.js "W2KPROA_USA.iso" --desc --truncate > desc.txt
while true; do
    python update.py ms-technet-w2kproa_usa "Microsoft TechNet W2KPROA_USA Disc (August 1999)" desc.txt
    if [ $? -eq 0 ]; then break; fi
    sleep 300
done
...
node dx.js "W2KPROI_USA.iso" --desc --truncate > desc.txt
while true; do
    python update.py ms-technet-w2kproi_usa "Microsoft TechNet W2KPROI_USA Disc (August 1999)" desc.txt
    if [ $? -eq 0 ]; then break; fi
    sleep 300
done
...
node dx.js "W2KSRVA_USA.iso" --desc --truncate > desc.txt
while true; do
    python update.py ms-technet-w2ksrva_usa "Microsoft TechNet W2KSRVA_USA Disc (August 1999)" desc.txt
    if [ $? -eq 0 ]; then break; fi
    sleep 300
done
...
node dx.js "W2KSRVI_USA.iso" --desc --truncate > desc.txt
while true; do
    python update.py ms-technet-w2ksrvi_usa "Microsoft TechNet W2KSRVI_USA Disc (August 1999)" desc.txt
    if [ $? -eq 0 ]; then break; fi
    sleep 300
done
...
node dx.js "Y2K9908.iso" --desc --truncate > desc.txt
while true; do
    python update.py ms-technet-y2k9908 "Microsoft TechNet Y2K9908 Disc (August 1999)" desc.txt
    if [ $? -eq 0 ]; then break; fi
    sleep 300
done
...
node dx.js "Y2K9911.iso" --desc --truncate > desc.txt
while true; do
