...
sleep 600
# uploading MSTN-CD139-SQLDEV.iso
cp "/Users/jeff/Library/CloudStorage/OneDrive-Personal/Software/Discs/Microsoft/TechNet/MSTN-CD139-SQLDEV.iso" SQLDEV.iso
cp "/Users/jeff/Library/CloudStorage/OneDrive-Personal/Software/Discs/Microsoft/TechNet/MSTN-CD139-SQLDEV.png" SQLDEV.png
node dz.js "SQLDEV.iso" --desc > desc.txt
python upload.py ms-technet-sqldev "Microsoft TechNet SQLDEV Disc (July 2004)" 2004-07-19 "Microsoft" "TechNet" desc.txt SQLDEV.iso SQLDEV.png
rm desc.txt SQLDEV.iso SQLDEV.png
sleep 600
