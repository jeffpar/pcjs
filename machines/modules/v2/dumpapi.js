/**
 * @fileoverview PCjs Dump API Definitions
...
export default class DumpAPI {
     ...
     */
    static asDiskCommands = [DumpAPI.QUERY.DIR, DumpAPI.QUERY.DISK, DumpAPI.QUERY.PATH];
    static asFileCommands = [DumpAPI.QUERY.FILE];
}
