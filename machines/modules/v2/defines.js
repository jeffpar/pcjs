...
Defines.LICENSE = LICENSE;
Defines.CSSCLASS = CSSCLASS;
Defines.SITEURL = SITEURL;
Defines.COMPILED = COMPILED;
Defines.DEBUG = DEBUG;
Defines.DEBUGGER = DEBUGGER;
Defines.MAXDEBUG = MAXDEBUG;
Defines.PRIVATE = PRIVATE;
Defines.RS232 = RS232;

export { APPVERSION, COPYRIGHT, LICENSE, CSSCLASS, SITEURL, COMPILED, DEBUG, DEBUGGER, MAXDEBUG, PRIVATE, RS232 }
