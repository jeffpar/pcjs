		...
		<div id="{$id}" class="{$componentClass}" style="{$width}{$height}{$pos}{$left}{$top}{$padding}" data-value="{$machineParms}">
			...
			<xsl:if test="$component = 'machine'">
				...
				<div class="{$CSSCLASS}-copyright">
					<a href="{$SITEURL}" target="_blank"><xsl:value-of select="$APPNAME"/></a> v<xsl:value-of select="$APPVERSION"/> © 2012-2026 <a href="https://github.com/jeffpar" target="_blank">Jeff Parsons</a>
				</div>
