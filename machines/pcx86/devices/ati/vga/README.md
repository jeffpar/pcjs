...
and merge them into a single 64Kb file, using the PCjs [FileImage](/tools/fileimage/) utility:
	...
	fileimage.js --file=1988-11-11/archive/VGA_Wonder_V3-1.02_EVEN.BIN --merge=1988-11-11/archive/VGA_Wonder_V3-1.02_ODD.BIN --format=rom --output=1988-11-11/archive/VGA_Wonder_V3-1.02.rom

Then, within the resulting 64Kb file, we extract the ROM code+data from the upper 32Kb:

	fileimage.js --file=1988-11-11/archive/VGA_Wonder_V3-1.02.rom --offset=32768 --format=bytes --comments --output=1988-11-11/VGA_Wonder_V3-1.02.json5
...
To create a human-readable dump, you can use the following command:
	...
	fileimage.js --file=1988-11-11/VGA_Wonder_V3-1.02.json5 --format=bytes --comments
