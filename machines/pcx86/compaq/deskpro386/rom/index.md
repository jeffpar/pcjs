...
[1988-01-28.json](1988-01-28/1988-01-28.json) was created with the PCjs [FileImage](/tools/fileimage/) utility;
for the sake of brevity, `fileimage` is used here as an abbreviation for `node ../../../../../../tools/fileimage/fileimage.js`:

	cd 1988-01-28
	fileimage --file=109592-001.hex --merge=109591-001.hex --output=1988-01-28.json

For a more human-readable dump, use the `--comments` option:

	fileimage --file=109592-001.hex --merge=109591-001.hex --output=1988-01-28.json --comments
...
from the two 16Kb BIN files provided by [Al Kossow](http://www.vintage-computer.com/vcforum/member.php?2256-Al-Kossow):
	...
	cd 1989-04-14
	fileimage --file=archive/109592-005.U11.bin --merge=archive/109591-005.U13.bin --output=archive/1989-04-14.rom --format=rom
	fileimage --file=archive/1989-04-14.rom --output=1989-04-14.json
...
In the current directory, an original ROM can be regenerated from the JSON-encoded file:
    ...
    cd 1988-01-28
	fileimage --file=1988-01-28.json --output=1988-01-28.rom --format=rom
...
Next, the PCjs [TextOut]({{ site.github.pages }}/tools/misc/old/textout/) command, with the *--nasm* option, prepares the code for reassembly:

	node ../../../../../../tools/misc/old/textout/bin/textout.js --file=1988-01-28.asm --nasm > temp.asm
