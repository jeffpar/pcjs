...
{% include gallery/documents.html title="TI-57/EC-4000 Documentation" cover_height="300" tag="manuals" %}

{% include gallery/documents.html title="TI-57/EC-4000 Programs" cover_height="300" tag="programs" %}
