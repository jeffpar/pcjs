---
layout: page
title: "PC-SIG Diskette Library (Disk #4137)"
permalink: /software/pcx86/sw/misc/pcsig/4000-4999/DISK4137/
machines:
  - id: ibm5170
    type: pcx86
...
{% raw %}
```
                    BERT'S PREHISTORIC ANIMALS, Version 3.2

    Congratulations, you have a trial shareware copy of BERT'S PREHISTORIC 
ANIMALS, which now includes voice. BERT'S PREHISTORIC ANIMALS is an enjoyable 
...
BPA32.DOC and also in REGIST32.DOC. 

    To install BERT'S PREHISTORIC ANIMALS on your hard disk (drive C:), insert 
the diskette in drive A: and type the following: 

        1. Type A:
        2. Type INSTALL A C
             (INSTALL B D will install from the B drive to the D drive)
        3. Type BERT to run your Bert's Prehistoric Animals program

    BERT'S PREHISTORIC ANIMALS requires a VGA display and a mouse to operate. 
All of the files on the BERT'S PREHISTORIC ANIMALS diskette must be in the 
...
to find the image files. To print the manual for BERT'S PREHISTORIC ANIMALS 
type COPY BPA32.DOC PRN. Sound Blaster owners should refer to the manual for 
operational details. 
...
### Directory of PC-SIG Library Disk #4137
    ...
    READ1ST  TXT      1401   9-01-93   1:00p
    BPACOMP  ARJ    236768  10-21-93   4:28p
           10 file(s)     356648 bytes
                               0 bytes free
