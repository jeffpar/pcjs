---
layout: page
title: "PC-SIG Diskette Library (Disk #4180)"
permalink: /software/pcx86/sw/misc/pcsig/4000-4999/DISK4180/
machines:
  - id: ibm5170
    type: pcx86
...
FLIX Productions Animated Software Order Form          (1/15/93)


                                 Circle Price of desired items

"The Animated Alphabet"......................... PRICE:  $8.00

"Animated Shapes"............................... PRICE:  $8.00

"The Animated Mother Goose"..................... PRICE:  $3.00

"Animated Math"................................. PRICE: $10.00

"The Animated Memory Game"...................... PRICE:  $6.00

"Animated Words"................................ PRICE: $12.00

"Animated Multiplication and Division".......... PRICE: $10.00

"Animated Clock"................................ PRICE:  $8.00

Total Enclosed.................................. $ ___________

CIRCLE THE TYPE MEDIA YOU WANT YOUR PROGRAMS TO BE SENT ON:

    360K 5.25" Disks        or           720K 3.5" Disks

All prices include postage and handling in the U.S.  For orders
outside the U.S., Please include an additional $1.00 total.

Where would you like your programs sent:
...
Tom Guthery IV,    601 Ranch Road,    DelValle TX     78617

```
{% endraw %}
...
{% raw %}
```
Known problems (and in some cases, fixes):
...
The software must be installed to your hard drive.
...
TSR's (Terminate and stay resident programs), that can "pop-up"
while other things are running can lead to unexpected results...
__________________________________________________________________

GRASPRT.EXE is a DOS program (it is the run-time module for the
...
using multimedia extensions.  The reason for this is primarily that
the high-resolution animation (and digital sound for "Animated
Words") requires ALL of the resources of your PC.
__________________________________________________________________

Some of the software is invoked from a batch (.BAT) file.  
...
Some of the programs are run from an .EXE file (AWORDS.EXE), so it
should behave just like any other program with a menu.
__________________________________________________________________

"The Animated Memory Game" is invoked with the AMEM.BAT file, not
AMEN.BAT (AMEM vs. AMEN)
__________________________________________________________________

Digital sound for "Animated Words":
...
VPLAY included with the SoundBlaster software conflicts with the
detection and sound routines used in "Animated Words".  Running
TEST-SBC seems to clear it, but it is recommended that your don't
run VPLAY before running AWORDS.  Other sound software may conflict
as well, it is best that you run AWORDS before running any other
...
I do extensive Beta-testing, but the DOS world is somewhat
...
{% raw %}
```
Animated New Testament                    FLIX Productions 
Registration:NONE                        To Run: Type NEWT

"The Animated New Testament" is a game to help children (and 
adults) learn the books of the New Testament.

The books of the New Testament are scrambled into a random
order, and using either the mouse or keyboard, the user  
selects them in the proper sequence.  An animated reward is
given for successful completion.

"The Animated New Testament" was written by an artist with 
over 15 years' experience in the field of classical animation.
                  
Please look at the file README.COM for information about other
FLIX Productions software. Please use the file ORDER.DOC when
registering other software.  There is no registration fee 
requested for "The Animated New Testament".

Hardware Requirements:   IBM PC  or PC compatible computer,
640K RAM, EGA or VGA. 
...
### Directory of PC-SIG Library Disk #4180

     Volume in drive A has no label
     Directory of A:\

    NEWT     ZIP    204984  10-21-93   1:55p
