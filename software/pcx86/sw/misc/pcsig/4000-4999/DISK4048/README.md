---
layout: page
title: "PC-SIG Diskette Library (Disk #4048)"
...
```
  ...
  ■ SOFTWARE SUPPORT POLICY for DAYO (tm)
   ...
   2.  Support (included with registration) remains in effect for 3 months
       after the date of registration or purchase.

   3.  Support is available through the following methods:

       - Phone/Voice Mail: (407) 292-4708

       - U.S. Mail:  TJS LAB, Inc., 5104 North Orange Blossom Trail # 200
				    Orlando, FL 32810
