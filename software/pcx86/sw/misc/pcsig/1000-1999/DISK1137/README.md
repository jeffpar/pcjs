...
```
Disk No: 1137
Program Title: SEARCHLIGHT BBS version 1.30 (Disk 2 of 2)
PC-SIG version 1.2

This is the second disk of SEARCHLIGHT BBS. You do need both disks to run
the system. The numbers in the set are #1136 and #1137. For a description
of the program refer to disk #1136.

Usage:  Bulletin Board System.

Special Requirements:  Hayes compatible modem, a free telephone line,
RS232 serial port, and 256K memory.  A hard disk is strongly
recommended.

How to Start:  Type GO (press enter).

Suggested Registration:  $35.00, or $70.00 for the extended version or
$95.00 for the multi-user version.

File Descriptions:

SLBBS    DOC  Searchlight BBS full documentation.
QUICK    DOC  Quick installation instructions.
FILEDEF  LIB  Commented file definitions (tech. info for programmers).
READ     LIB  Sample message read routine.
SL-PIF   DVP  Data file.
MANUAL   BAT  Batch file to print documentation.
DOOR     PAS  Subrogram.
HELP     TXT  Help information.
???????? MH   Overlay file (23 files).
???????? FH   Overlay file (19 files).
???????? SH   Overlay file (8 files).
...
In addition, the file HELP.ARC, containing the online help files, will be 
...
the Text File Path.  Install the Searchlight online HELP files by un-ARCing the 
file TEXT.ARC into this directory (or, if you did not receive your HELP files 
