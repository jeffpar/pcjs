...
```
Disk No: 1634                                                           
Disk Title: Fugue Utilities                                             
PC-SIG Version: S1.2                                                    
                                                                        
Program Title: Fugue Utilities                                          
Author Version: 1.0                                                     
Author Registration: $15.00                                             
Special Requirements: Some utilities require Epson compatible printer.  
                                                                        
FUGUE UTILITIES is a package of four useful file management utilities   
that are missing from MS-DOS:  INFO, CAT, TELL, DIR, FI, CHD, EXCLUDE,  
ASK, YES, WHEREIS, FILTER, and XQT.                                     
...
from the command line and gives a brief summary of DOS commands and     
utility programs (format, assign, etc).  This is helpful if you have    
forgotten the order of the DOS chmod parameters and don't feel like to  
digging through the reference manual.                                   
...
FI displays a browse list of files and allows the addition of           
descriptions to files in full screen mode.  Press Return to edit the    
description of highlighted file.  The descriptions are stored in file   
FILEINFO.WF in the directory being browsed.                             
                                                                        
Several parameters allow selection of direction files to be displayed,  
including System and Hidden.  To maintain upwards compatibilty, the     
program will also convert files from INFO to the new format, renaming   
them FILEINFO.WF.                                                       
...
EXCLUDE is used to exclude files from DOS commands.  Prefix the DOS     
command by EXCLUDE <filespecs>.                                         
