...
```
Disk No: 1403
Disk Title: LoveDOS (Penname now on #1710)
PC-SIG Version: S2

Program Title: LoveDOS
Author Version: 1
...
{% raw %}
```
LOVEDOS was conceived as a change of pace from
all the practical joke programs that insult the
user. LOVEDOS responds intelligently to a number
of DOS commands and keystrokes, and has its own
repertoire of friendly comments. The way to escape
is to tell you computer that you love it.

```
{% endraw %}
