...
1410    REM DEFDBLDEFDBL RETURN
1420 RETURN
1430    REM DEFDBLDEFDBL ERROR
1440 CLS:BEEP:LOCATE 23,1:COLOR 6,0:PRINT"ERROR: ";:KEY ON:ON ERROR GOTO 0
1450    REM DEFDBLDEFDBL START Program
...
1170     REM: DEFDBLDEFDBL PRINT INSTRUCTIONS
...
1200 RETURN
1210      REM: DEFDBLDEFDBL START program
...
1570      REM: DEFDBLDEFDBL EDIT DISK ID
...
1770      REM: DEFDBLDEFDBL READ DISK ID
...
1880      REM: DEFDBLDEFDBL ERROR out
...
2460 END
2470      REM:  DEFDBLDEFDBL UPPERCASE
...
1260      REM: DEFDBLDEFDBL START program
...
1690 GOTO 1320
1700      REM: DEFDBLDEFDBL HANDSHAKE
...
2060 GOTO 1940
2070      REM: DEFDBLDEFDBL DATIME
2080 DATIME$=DATE$+"  "+LEFT$(TIME$,5):RETURN
2090      REM: DEFDBLDEFDBL PARALLEL
...
2300 GOTO 1310
2310      REM: DEFDBLDEFDBL SMART MODEM
...
1070      REM: DEFDBLDEFDBL PROGRAM KEYS
1080 KEY OFF: KEY 1,CHR$(27)+"CLS:LIST "
1090 KEY 2,CHR$(27)+"RUN  "+CHR$(7):KEY 3,CHR$(27)+"LOAD"+CHR$(7)+CHR$(34)
1100 KEY 4,CHR$(27)+"SAVE "+CHR$(34):KEY 5,CHR$(27)+"RUN"+CHR$(7)+CHR$(34):KEY 6,CHR$(27)+"GOTO 1000"
1110 KEY 7,CHR$(27)+CHR$(12)+"FILES "+CHR$(34)+"A:*.*":KEY 8,CHR$(27)+"RENUM 1000"
1120 KEY 9,CHR$(12)+"COLOR 6,0:CLS"+CHR$(13):KEY 10,CHR$(27)+"RUN"+CHR$(34)+"AUTOST"
1130     REM: DEFDBLDEFDBL PRINT TEMPLATE
...
1240     REM: DEFDBLDEFDBL FUNCTION KEY TEMPLATE
...
1070     REM: DEFDBLDEFDBL PRINT TEMPLATE
...
1180     REM: DEFDBLDEFDBL FUNCTION KEY TEMPLATE
...
1240     REM: DEFDBLDEFDBL START PROGRAM
