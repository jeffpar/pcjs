...
4040 P=P+1
4050 NEXT
4060 IF A(P-1)<=1THEN GOTO 4200
4070 F=P-1
4080 FOR V=1TO A(F)-1
4090 A(P)=A(F-3)+V*100
4100 IF A(P)>=1300THEN A(P)=A(P)-1199
...
4300 RETURN
10000 GOSUB 4000
10100 LOCATE 24,1:INPUT "WHAT YEAR DO YOU WANT ANALYZED YYYY";Y:CLS:IF Y>1984 OR Y<1973 THEN BEEP:PRINT"INCORRECT ENTRY. ENTER A YEAR BETWEEN 1973 AND 1984.":FOR AX=1TO 3000:NEXT:BEEP:GOTO 10100
...
10900 RETURN
15000 GOSUB 4000
15100 INPUT "WHAT MONTH DO YOU WANT ANALYZED? ENTER NUMBER...";N:IF N>12 OR N<1 THEN BEEP:PRINT:PRINT"INCORRECT INPUT. ENTER A NUMBER FROM 1 TO 12.":FOR AS=1TO 3000:NEXT:BEEP:GOTO 15100
...
15250 IF A(M+1)<>0THEN C=A(M+2)/A(M+1)ELSE C=0
