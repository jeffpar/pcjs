...
110 ' RESERVED WORDS
120 '
130 DATA ABS,ALL,AND,APPEND,ASC(,AS,ATN,AUTO,BEEP,BLOAD,BSAVE:Å 1-11
131 DATA CALL,CDBL,CHAIN,CHDIR,CHR$(,CINT,CIRCLE:Å 12-18
135 DATA CLEAR,CLOSE,CLS,COLOR,COMMON,COM,CONT:Å 19-25
140 DATA COS,CSNG,CSRLIN,CVD,CVI,CVS,DATA,DATE$:Å 26-33
150 DATA DEFDBL,DEFINT,DEFSNG,DEFSTR,DEF FN, DEF SEG,DEF USR,DELETE,DIM,DRAW:Å 34-43
159 DATA EDIT,ELSE,END,ENVIRON$,ENVIRON,EOF,EQV,ERASE,ERDEV$,ERDEV,ERL,ERROR,ERR,EXP,FIELD,FILES,FIX,FOR,FRE:Å 44-62
170 DATA GET,GOSUB,GOTO,HEX$:Å 63-66
180 DATA IF,IMP,INKEY$,INPUT$,INPUT#,INPUT,INP,INSTR,INTER$,INT(,IOCTL$,IOCTL,KEY$,KEY,KILL,LEFT$(,LEN,LET,LINE:Å 67-85
190 DATA LLIST,LIST,LOAD,LOCATE,LOC,LOF,LOG,LPOS,LPRINT,LSET,MERGE,MID$(,MKDIR,MKD$(,MKI$(:Å 86-100
200 DATA MKS$(,MOD,MOTOR,NAME,NEW,NEXT,NOT,OCT$,OFF,ON,OPEN,OPTION BASE,OR,OUTPUT,OUT,PAINT,PEEK:Å 101-117
210 DATA PEN,PLAY,PMAP,POINT,POKE,POS,PRESET,PRINT#,PRINT,PSET,PUT:Å 118-128
220 DATA RANDOMIZE,READ,REM,RENUM,RESET,RESTORE,RESUME,RETURN,RIGHT$(,RMDIR,RND(,RSET,RUN:Å 129-141
230 DATA SAVE,SCREEN,SGN,SHELL,SIN,SOUND,SPACE$(,SPC(,SQR,STEP,STICK,STOP,STR$(:Å 142-154
240 DATA STRIG,STRING$,SWAP,SYSTEM,TAB(,TAN,THEN,TIME$,TIMER,TO,TROFF,TRON:Å 155-166
250 DATA USING,USR,VAL,VARPTR$,VARPTR,VIEW,WAIT,WEND,WHILE,WIDTH,WINDOW,WRITE#,WRITE,XOR: Å 167-180
...
160 DATA FIELD,FILES,FIX,FOR: Å 48-51
