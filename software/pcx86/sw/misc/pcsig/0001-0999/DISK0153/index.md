...
Program Title: Hangman by Norsoft                                       
Author Version: 5.15                                                    
...
HANGMAN is a game that enhances spelling and vocabulary. The program    
picks problems for you to solve from a diversified collection of data   
files, where the vocabulary of words and phrases is extensive keeping   
things from getting boring through repetition. You play against         
yourself, so at least you know the quality of the competition, although 
some players have been known to be surprised even then.                 
...
```
        ...
        HANGMAN requires a 128K or larger IBM Personal Computer with one
        disk drive and an 80-column display.


        STARTING THE GAME

        To begin playing the game, place your backup copy of HANGMAN into
        Drive A, then type HANGMAN to start the game.  The first
        ...
        On some computers the HANGMAN screens are difficult to read.  If 
        you encounter this problem, press 'M' at the Main Menu to switch 
        to a monochrome display.  If this procedure corrects the problem,
        press 'Ctrl-S' at the Main Menu to store monochrome as your
        display type.
        ...
        comments to NORLAND SOFTWARE.
                      ...
                      Eric N. Miller - Norland Software
                              P. O. Box 84499      
                         Los Angeles, CA  90073-4499
 ...
 definitely not for children.  Price: $15.
 ...
 Be sure to specify the language desired when ordering. Price: $15.
 ...
 HANGMAN; SPANISH HANGMAN).  Price: $15.


 SYSTEM REQUIREMENTS FOR ALL GAMES:  80-column display, one disk drive, 
 128K of memory.

```
{% endraw %}
