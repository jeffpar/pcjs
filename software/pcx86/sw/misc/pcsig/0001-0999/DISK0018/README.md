...
1550 CLS:GOSUB 2100
1560 LOCATE 2,1:PRINT"Approximate fuel:";:COLOR 15:PRINT INT(WF-4+RND*10);:COLOR 7:PRINT TAB(36) "Speed: ";:COLOR 15:PRINTSP:COLOR 7
1570 PRINT"        Odometer: ";:COLOR 15:PRINTMF;:COLOR 7:PRINT TAB(30) "Miles to go: ";:COLOR 15:PRINTMT(RT)-MF:COLOR 7
1580 PRINT
...
5250 XT=0.06500001*WL:PRINT USING"     Total for the load: $#,###.##";XT
