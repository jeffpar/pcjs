...
--> FILE:  SOFT82  .DTA         CRC = A0 A5

--> FILE:  SOFT82  .INX         CRC = 77 7F

--> FILE:  SOFT82  .HDR         CRC = 24 85

--> FILE:  SOFT82  .KEY         CRC = 8A 91

--> FILE:  PCMAG82 .DTA         CRC = A9 C0

--> FILE:  PCMAG82 .INX         CRC = 8B ED

--> FILE:  PCMAG82 .HDR         CRC = 24 85

--> FILE:  PCMAG82 .KEY         CRC = 3C AF

--> FILE:  PCAGE82 .DTA         CRC = 51 BF

--> FILE:  PCAGE82 .INX         CRC = 44 39

--> FILE:  PCAGE82 .HDR         CRC = 24 85

--> FILE:  PCAGE82 .KEY         CRC = CE 91

--> FILE:  BYTE82  .DTA         CRC = 03 56

--> FILE:  BYTE82  .INX         CRC = 40 11

--> FILE:  BYTE82  .HDR         CRC = EC 49

--> FILE:  BYTE82  .KEY         CRC = 63 BB

--> FILE:  LETUS   .BAT         CRC = 00 00

--> FILE:  LOGO82  .COM         CRC = C2 C7

--> FILE:  PLOGO82 .COM         CRC = 90 95

--> FILE:  LETUS   .DOC         CRC = 68 DA
...
-
	...
	directly from Jim Button by sending a diskette and a self-addressed
	stamped mailer to:
...
-
	...
	files containing lists of keyword strings (magazineyear.KEY)
...
-
	...
	-------------------------------------------------------------------
	  1	SOFT82.DTA    22784  Softalk   1982   Jun/1	       55
	       ...
	       PCMAG82.DTA    91392  PC        1982   Feb-Mar/1(1)    222
		      ...
		      .HDR	128		      Dec/1(8)
		      .KEY     5724
	       PCAGE82.DTA    39680  PC Age    1982   Mar/1.3  *       95
		      .INX     2176		      thru
		      .HDR	128		      Dec/1.9
		      .KEY     2540
	...
	-------------------------------------------------------------------
	  2	SOFT83.DTA    94208  Softalk   1983   Jan/1	      230
	      ...
	      PCMAG83A.DTA    80384  PC        1983   Jan/1(9)	      195
		      ...
		      .HDR	128		      Jun/2(1)
		      .KEY     6713
	       PCAGE83.DTA    80896  PC Age    1983   Jan/2.1	      196
		      .INX     4352		      thru
		      .HDR	128		      Nov/2.11
		      .KEY     5789
	-------------------------------------------------------------------
	...
	* Note:  Volumes 1.1 and 1.2 of PC Age, which are out of print,
		 are missing from the Letus A-B-C database.
...
-
	...
	"magazineyear.KEY", that contain a sorted list of keyword-strings
	...
	keyword files, do the following:
	  ...
	  3.  Type "COPY d:magazineyear.KEY PRN" and press the "ENTER" key.
	      (e.g., COPY A:PCMAG83A.KEY PRN if you have Disk #2 in the "A"
