...
{% raw %}
```
Welcome to Look and Listen 1,2,3...
Registration Fee: $9.95 ($39.80 for all 7 Look and Listen 
    ...
    Send to: Attn: Look and Listen Registration
             ...
             Redmond, WA 98052
             (206) 861-5463
Look and Listen 1,2,3... includes InWin: an install
...
------------------------------------------------------------------
Look and Listen 1,2,3... - Educational program in Windows for
                           pre-schoolers (Counting).
------------------------------------------------------------------

TITLE: Look and Listen 1,2,3...,  Version 5.0
...
TOTAL of File Sizes: 286,588 bytes
...
------------------------------------------------------------------
  HOW TO INSTALL Look and Listen 1,2,3...
...
Registration Fee: $9.95 ($39.80 for all 7 Look and Listen 
    ...
    Send to: Attn: Look and Listen Registration
             ...
             Redmond, WA 98052
             (206) 861-5463
Look and Listen 1,2,3... includes InWin: an install program
...
etc..
     ...
     Look and Listen 1,2,3... - Short Description:

        Look and Listen 1,2,3..., Version 5.0 - $9.95
        ...
        that young mind how to count with colorful pictures
        and sounds.  Have loads of fun re-coloring the
        pictures within Windows Paint.
     ...
     Look and Listen 1,2,3... - Long Description:

        Look and Listen 1,2,3..., Version 5.0 - $9.95

        Look and Listen 1,2,3... is an educational picture
        and sound program that takes advantage of the existing
        computer speaker or installed sound device.  Grab your
        pre-schooler's attention with colorful pictures and
        fun sounds!.  Teach your kids how to count and
        introduce them to a computer at the same time.  Have
        loads of fun with re-coloring the pictures within
        Windows Paint.  Sound Off, Loop and Delay are handy
        features for testing and teaching. InWin, an easy
...
Listen 1,2,3... produced by Softline, Inc..  Look and Listen
1,2,3... and its' associated files, documentation, and help
files are NOT in the public domain.  Look and Listen 1,2,3... is
owned by Softline, Inc., Redmond, WA., U.S.A., the copyright
holder.  Look and Listen 1,2,3... is a trademark of Softline,
...
copyright and are outlined below.
    ...
    - No organization may sell the Shareware versions of Look
      and Listen 1,2,3... without prior written permission from
...
distribute Look and Listen 1,2,3... .  If you are already a
...
You may distribute the Look and Listen 1,2,3... product on the
following terms:
- Look and Listen 1,2,3..., when listed in vendors' catalogues,
  advertisements, brochures, mailers, etc. must be named
  "Look and Listen 1,2,3...".

- Look and Listen 1,2,3... may NOT be sold as part of some
  other more inclusive package without a license from
  Softline, Inc..

- Look and Listen 1,2,3... must not be distributed with other
  Shareware or public domain programs on the same floppy disk
  without permission from Softline, Inc..  However, Look and
  Listen 1,2,3... may be included in libraries sold on CD-ROM
...
- Look and Listen 1,2,3... - including all related program files
...
- No price or other compensation may be charged for Look and
  Listen 1,2,3... . A reasonable distribution cost may be
  charged for the cost of the diskette plus shipping and
  handling.

- Look and Listen 1,2,3... CANNOT be sold as part of some other
  ...
  1,2,3... be "rented" or leased to others.

- Any distribution of Look and Listen 1,2,3... over bulletin
...
------------------------------------------------------------------
VENDOR STANDARDS:
  In order to distribute Look and Listen 1,2,3... you must agree
...
Listen 1,2,3..., Softline, Inc. will forward a Vendor Master
Distribution disk.  Updates will be offered to approved
organizations on a case-by-case basis.

     Look and Listen 1,2,3... is produced by Softline, Inc.
     ---------------------------------------------------
    Look and Listen 1,2,3... is a trademark of Softline,Inc.
...
VENDOR.DOC                              Look and Listen 1,2,3...
```
{% endraw %}
