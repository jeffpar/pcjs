---
layout: page
title: "PC-SIG Diskette Library (Disk #3167)"
permalink: /software/pcx86/sw/misc/pcsig/3000-3999/DISK3167/
machines:
  - id: ibm5170
    type: pcx86
...
CLYDE'S ADVENTURE - CHAPTER ONE       COPYRIGHT (c) 1992 MOONLITE SOFTWARE

  *  Please make a backup of the original archive or distribution diskette
     before using this software.
  *  Run MOONLITE.EXE for important information.
  *  Run CLYDE1.EXE to start the game.

  This shareware package was released August 30 1992 by Moonlite Software.

```
{% endraw %}
...
--------------------------------------------
Clyde's Adventure Version 2.0 Released September 1992
...
------------------------
Please use the following descriptions whenever possible:
...
----------------
  PACKING LIST
----------------
  The shareware distribution package for Clyde's Adventure V2.0 contains:
...
### Directory of PC-SIG Library Disk #3167

     Volume in drive A has no label
     Directory of A:\

    CLYDE    ZIP    179506  10-27-92   3:55p
    ...
    GO-STRT  DAT       551  10-27-92   3:48p
            9 file(s)     244192 bytes
                           73728 bytes free
