...
version 1.2	Now saves all info when the clock is moved.
...
version 1.3	All alarm screens will stay ON TOP until answered.
...
version 1.4	Better STAY ON TOP effect.
