...
```
Disk No: 3000
Disk Title: Secret Agent:The Hunt for Red Rock Rover
PC-SIG Version: S1

Program Title: Secret Agent - The Hunt for Red Rock Rover
Author Version: 1.0
Author Registration: $15.00 a volume or $30 for all three.
Special Requirements: EGA/VGA and high density drive. Hard drive
                      recommended.

A Top-Notch EGA/VGA Action/Adventure Scrolling Game.

You're agent 006-1/2, top agent of the government's secret organization
committed to protecting the world against terrorists and power-mad
criminals.

Your mission: To parachute into a high-security island outpost and secur
the plans to the ultimate satellite laser weapon, which was recently sto
from the government.  In the wrong hands this weapon could mean world
control by the DVS, the world's most dangerous terrorist organization.

You will be isolated from outside help as you parachute into the secret
fortress of the DVS.  You will need to knock out the vast security syste
bypass dozens of extreme traps, overcome hundreds of multi-talented guar
(such as thugs, ninjas, sharp-shooters, knife throwers, sentries, dogs,
many robots), and find the missing blue prints.  If possible, take out t
devious leader of the DVS (sorry, no file picture available).

If you liked Commander Keen or Duke Nukum, this game is just what you're
looking for.  Lots of interesting situations to overcome and traps to wo
around. This game has great puzzles that make it much more than a simple
run-jump-and-shoot contest.  Superb colorful graphics and scrolling
levels. James Bond never had it so tough!

Secret Agent is a full-screen scrolling game where you sneak around a hu
map and enter various hideouts.  In each unique hideout you'll search fo
the laser blue prints, dodge traps, solve puzzles, and blast the bad guy
All in good fun.  Save/restore, joystick support, EGA/VGA graphics, and
much more.

Order the Entire Trilogy and Save $15!

Each episode of Secret Agent is $15, or you can order (and register) all
three episodes for just $30.  As an incentive to order all three episode
you'll also get the hints sheet, the cheat codes, and a new bonus game f
Apogee.  Plus, you'll be able to call the Secret Agent hints line or mai
questions to Apogee for assistance.
