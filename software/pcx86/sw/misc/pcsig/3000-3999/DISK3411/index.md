...
{% raw %}
```
Welcome to Look and Listen Colors
Registration Fee: $9.95 ($39.80 for all 7 Look and Listen 
                      programs) + S & H (US Funds only)
    Send to: Attn: Look and Listen Registration
             Softline, Inc
             15377 N.E. 90th
             Redmond, WA 98052
             (206) 861-5463
Look and Listen Colors includes InWin: an install
...
Step #5: After the Install is complete, double click the
         left mouse button on the Look and Listen icon to
         start the program.
Step #6: Select OK at the License reminder screen.
Step #7: For instructions (HELP): press <F1> key.
...
{% raw %}
```
Look and Listen Colors                           VENDOR.DOC
               
       D I S K  V E N D O R   I N F O R M A T I O N
       --------------------------------------------
 This file provides information for disk vendors who wish to
distribute Look and Listen Colors via their disk duplication
and distribution services.  If you wish to distribute Look and
Listen Colors and other Softline programs, then call or write
...
------------------------------------------------------------------
Look and Listen Colors - Educational program in Windows for
                         pre-schoolers (Colors).
------------------------------------------------------------------

TITLE: Look and Listen Colors,  Version 5.0
         For Microsoft Windows 3.0/3.1
         Last updated:  May 1993
REGISTRATION FEE: $9.95 ($39.80 for all 7 Look and Listen
                  programs) + shipping and handling (US Funds)
CATEGORIES: Windows, Educational.
TARGET USER(S): Parents, Teachers with Windows.
...
TOTAL of File Sizes: 337,388 bytes
...
------------------------------------------------------------------
  HOW TO INSTALL Look and Listen Colors
     
   A README.TXT file is on the disk.  This file contains the
...
Registration Fee: $9.95 ($39.80 for all 7 Look and Listen 
    ...
    Send to: Attn: Look and Listen Registration
             ...
             Redmond, WA 98052
             (206) 861-5463
Look and Listen Colors includes InWin: an install program
...
Step #4: Type:   A:INSTALL   or    B:INSTALL
         ...
         on the screen.
Step #5: After the Install is complete, double click the
         left mouse button on the Look and Listen icon
...
etc..
     ...
     Look and Listen Colors - Short Description:

        Look and Listen Colors, Version 5.0 - $9.95

        Make learning a computer adventure for your child.
        Easy to use, Windows compatible, educational
        program that talks through the PC internal speaker
        or installed sound device in Windows!.  Teach
        that young mind how to identify various colors.
        Have loads of fun re-coloring the pictures within 
        Windows Paint.
     ...
     Look and Listen Colors - Long Description:

        Look and Listen Colors, Version 5.0 - $9.95

        Look and Listen Colors is an educational picture and
        sound program that takes advantage of the existing
        computer speaker or installed sound device.  Grab your
        pre-schooler's attention with colorful pictures and
        fun sounds!.  Teach your kids how to identify various
        colors and introduce them to a computer at the same
        time.  Have loads of fun with re-coloring the pictures
        within Windows Paint.  Sound Off, Loop and Delay are
        handy features for testing and teaching. InWin, an easy
        auto install program, run from within Windows, is
        included.
        Passed: Microsoft Compatibility for Windows testing.
        Requires: Microsoft Windows 3.0 or 3.1 (Standard or
                  Enhanced modes), operates through the PC
...
ANY fee for the distribution of the Shareware version of Look and
Listen Colors produced by Softline, Inc..  Look and Listen
Colors and its' associated files, documentation, and help
files are NOT in the public domain.  Look and Listen Colors is
owned by Softline, Inc., Redmond, WA., U.S.A., the copyright
holder.  Look and Listen Colors is a trademark of Softline,
Inc..  Distribution restriction rights are claimed under that
copyright and are outlined below.

    - No organization may sell the Shareware versions of Look
      and Listen Colors without prior written permission from
      Softline, Inc..  To apply for such permission send a
      written request to:
         Softline, Inc. 
...
distribute Look and Listen Colors.  If you are already a
member of ASP or ASAD, please mention it in your request for
distribution.  With your request, please also send your most
current shareware catalogue.
...
You may distribute the Look and Listen Colors product on the
following terms:
- Look and Listen Colors, when listed in vendors' catalogues,
  advertisements, brochures, mailers, etc. must be named
  "Look and Listen Colors".

- Look and Listen Colors may NOT be sold as part of some
  other more inclusive package without a license from
  Softline, Inc..

- Look and Listen Colors must not be distributed with other
  Shareware or public domain programs on the same floppy disk
  without permission from Softline, Inc..  However, Look and
  Listen Colors may be included in libraries sold on CD-ROM
  disks and/or placed on POS rack methods of distribution.

- Printed copies of the manual may not be distributed in any
  form without a license from Softline, Inc. 

- Look and Listen Colors - including all related program files
  and documentation files - CANNOT be modified in any way and
  must be distributed as a complete package, without exception.

- No price or other compensation may be charged for Look and
  Listen Colors. A reasonable distribution cost may be charged
  for the cost of the diskette plus shipping and handling.

- Look and Listen Colors CANNOT be sold as part of some other
  inclusive package, nor can it be included in any commercial
  software packaging offer, without a written agreement from
  Softline, Inc..  Under no conditions will Look and Listen
  Colors be "rented" or leased to others.

- Any distribution of Look and Listen Colors over bulletin
  boards and/or national telecommunication services will be
  limited to distributing a single archived file containing the
  contents of the entire distribution disk and NO charge above
  the standard charge for connect time will be allowed.

- No vendor can sell registered packages to end-users without
  written permission from Softline, Inc..
------------------------------------------------------------------
VENDOR STANDARDS:
  In order to distribute Look and Listen Colors you must agree
to abide by the ASP and/or ASAD vendor standards whether you are
...
==================================================================
    ...
    To those organizations given permission to distribute Look and
Listen Colors, Softline, Inc. will forward a Vendor Master
Distribution disk.  Updates will be offered to approved
organizations on a case-by-case basis.

     Look and Listen Colors is produced by Softline, Inc.
     ---------------------------------------------------
    Look and Listen Colors is a trademark of Softline,Inc.
...
VENDOR.DOC                              Look and Listen Colors
```
{% endraw %}
