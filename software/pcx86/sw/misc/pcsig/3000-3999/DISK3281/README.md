...
After installing Disks 1 and 2 of MATH RESCUE to this subdirectory,
type MR1 to start the program.  MATH RESCUE is self explanatory and any
necessary documentation is found within the program.
```
{% endraw %}
