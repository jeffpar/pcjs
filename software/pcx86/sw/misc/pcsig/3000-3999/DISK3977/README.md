---
layout: page
title: "PC-SIG Diskette Library (Disk #3977)"
permalink: /software/pcx86/sw/misc/pcsig/3000-3999/DISK3977/
machines:
  - id: ibm5170
    type: pcx86
...
{% raw %}
```
               AEROSOFT FITNESS LOG REGISTRATION INVOICE
...
(  ) Check    (  ) VISA/MC __________________   Exp Date ____________________

(  ) 3-1/2    (  ) 5-1/4 Inch Diskettes

(  ) Aerosoft Fitness Log.................................    $49  __________

(  ) Alford Basketball Log................................    $49  __________

     Indiana Residents Add 5% Sales Tax...................         __________

(  ) Include Shareware Version Of Online Bible At No Charge
                                                            Total  __________

MAIL TO: AEROSOFT, PO BOX 501010, INDIANAPOLIS, IN 46250    PH#: 317-849-7659

```
{% endraw %}
...
{% raw %}
```
                 VENDOR DOC FOR THE AEROSOFT FITNESS LOG

short desc:
Exercise Log used in homes, business, schools and hospitals


long desc:
*  America's Fitness Log!!!
*  Calculates aerobic points for 34 types of exercise and calories burned for
   49 types of exercise.
*  Records all exercises featured in the Presidential Sports Award program
   and directs you in mailing for your Presidential Sports Awards.
*  Lets you view exercise history at your terminal.
*  Compares on a monthly basis current year aerobic point totals and
   cardiovascular fitness levels with the previous year.
*  Prints these reports
    - Detail Aerobic History
    - Monthly Summary Aerobic History
    - Rankings for Aerobic Points and Each of 49 Exercises
    - Cardiovascular Fitness Levels
    - Presidential Sports Awards
    - User IDs
*  Comes with tips on how to create a voluntary fitness program for the office.
*  Tracks up to 999 users per Log.
*  Optionally requires passwords.
*  Registered Version Includes
    - Presidential Sports Award brochure and poster
    - 40 page user manual
    - mailing label utility
    - exercise test utility
    - 3-1/5 and 5-1/4 inch diskettes


hdw requirements:
IBM-compatibles, DOS 2.0 or better


registration:
90 day evaluation period then you must either stop using it or buy a licensed
copy for $49.00


files needed for distribution disk:
file_id.diz
manual.doc
register.doc
read.me
...
### Directory of PC-SIG Library Disk #3977

     Volume in drive A has no label
     Directory of A:\

    AEROSOFT ZIP    120214   8-18-93   1:33p
