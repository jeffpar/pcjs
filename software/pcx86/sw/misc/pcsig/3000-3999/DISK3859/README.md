---
layout: page
title: "PC-SIG Diskette Library (Disk #3859)"
permalink: /software/pcx86/sw/misc/pcsig/3000-3999/DISK3859/
machines:
  - id: ibm5170
    type: pcx86
...
```
╔═════════════════════════════════════════════════════════════════════════╗
║            <<<<  PC-SIG Disk #3859 QUICLICK FOR WINDOWS  >>>>           ║
╠═════════════════════════════════════════════════════════════════════════╣
║                                                                         ║
║  To Install QUICLICK FOR WINDOWS, use: RUN under FILE in the            ║
║                                                                         ║
║  Program Manager and type Drive letter:\SETUP, then press the           ║
║                                                                         ║
║  ENTER key.                                                             ║
║                                                                         ║
║  The QUICLICK Setup program will take care of the rest.                 ║
║                                                                         ║
║                                                                         ║
...
### Directory of PC-SIG Library Disk #3859
    ...
    QUICLICK ZIP    253905   7-22-93  12:53p
    GO       EXE     26022   1-10-92  12:14p
    PKUNZIP  EXE     29378   2-01-93   2:04a
    PCSIG    TXT      2329   6-01-93   2:31p
    SHAREMAG TXT      1831   6-01-93   2:32p
    CDROM    TXT      8196   6-01-93   3:26p
    GO       TXT      1232   7-22-93  12:57p
           10 file(s)     330106 bytes
                           26624 bytes free
