---
layout: page
title: "PC-SIG Diskette Library (Disk #3728)"
permalink: /software/pcx86/sw/misc/pcsig/3000-3999/DISK3728/
machines:
  - id: ibm5170
    type: pcx86
...
{% raw %}
```
		KBS: People Management System
		Copyright ⌐ 1991-1992 KBS Systems
		All Rights Reserved
		Version 1.23
...
2) run a:\setup.exe (either by double clicking on the file 
			in File Manager 
			or by entering a:\setup.exe 
			on the File-Run command line.)

3) Specify the destination directory when prompted.

4) Start PMS by double clicking on the PMS Icon 
		in the KBS Programs folder.

5) Your first Database will be created in the directory where
		you installed PMS (the PMS Directory).

6) Choose to start Quick Start
	or
   From the menu choose File-Setup to describe your organization
		and the categories that you will be using.
		Make sure to specify your comport (com1,com2,etc.)
		before using autodial.

7) Start entering data.

8) Report any problems, comments or enhancements to:
    ...
    Prodigy:  CJBM05A
    Compuserve: 70062,3526

9) See file Register.wri for important information 
	on registering and other KBS products.
```
{% endraw %}
...
### Directory of PC-SIG Library Disk #3728

     Volume in drive A has no label
     Directory of A:\

    KBS      ZIP    203972   5-22-93   3:21p
    ...
    GO-STRT  DAT       551   5-22-93   3:49p
            9 file(s)     275149 bytes
                           41984 bytes free
