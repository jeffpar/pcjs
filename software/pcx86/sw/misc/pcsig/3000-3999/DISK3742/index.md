---
layout: page
title: "PC-SIG Diskette Library (Disk #3742)"
permalink: /software/pcx86/sw/misc/pcsig/3000-3999/DISK3742/
machines:
  - id: ibm5170
    type: pcx86
...
{% raw %}
```
Welcome to Soft Ventures installation program for Windows..
                      SVInstall

SVInstal is being distributed as shareware, 
          it is NOT free software. 

If you like SVInstal and continue to use it, you are required to
register with Soft Ventures. The Help system contains registration 
information.

The Help system acts as documentation for this application.
...
- Specify SVInstal in the drive which contains the distribution
  ie B:SVINSTAL if you are installing from drive B
- After install is comlpete, start INST_BULD and read the HELP!
  
Click on the 'Release Notes' icon after installation.
```
{% endraw %}
...
Version 1.41
February 1993
- Description text now supported for icons being put into
  the program group. see HELP for syntax.
- Fix for multi-disk bug - the multi-disk code actually
  sort of got omitted from the program but its there now.
- Program group name can contain spaces.
- Failure when installing compressed file from sub directory
  fixed.
- Accelerator keys added to buttons.


Bonus
-----
Registered users will receive Soft Ventures' two windows 
utilities - SVPaperHanger and SVSaveChanger. The versions sent 
will be for your use only. If you wish to distribute them with 
your software, Soft Ventures can supply versions with your logo
for a one time fee of $14.95US each or $24.95US for both.
If you wish to order these, send a '.BMP' file of your logo
(about 100 pixels wide x 50 pixels high) with cheque or money
order. 
...
### Directory of PC-SIG Library Disk #3742

     Volume in drive A has no label
     Directory of A:\

    SVINSTAL ZIP    195105   5-26-93  11:35a
    ...
    GO-STRT  DAT       540   5-26-93  12:09p
           10 file(s)     266811 bytes
                           50176 bytes free
