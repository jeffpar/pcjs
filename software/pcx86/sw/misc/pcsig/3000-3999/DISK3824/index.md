---
layout: page
title: "PC-SIG Diskette Library (Disk #3824)"
permalink: /software/pcx86/sw/misc/pcsig/3000-3999/DISK3824/
machines:
  - id: ibm5170
    type: pcx86
...
Drag and Drop support for Windows 3.1. 
More archive formats (I'm taking requests!).


v.2.22 

Added support for empty directories within archives.  Made minor cosmetic
changes.  Increased inflating speed by about 10%.  As of this release, WUNA
requires Windows 3.1 and a 386 or better.  (286 version available on request)

v2.21

Added support for PKZIP 2.04.  Fixed stack overflow problems.
...
Further refined memory managment.  Fixed a rarely occuring, UAE-producing
bug.  Sped up exploding by a very small amount.
...
Added ARJ support and renamed product "Windows UnArchive".  Redesigned 
main dialog box.  Fixed various small bugs.  Improved memory managment 
still more.  Added Run command, Try Out command, path variables, and 
several smaller enhancements.


v1.07

Fixed source and destination path bugs.  Changed command line processing for 
compatability with File Manager 3.1.  Improved memory management and error  
trapping.


v1.05

Fixed destination path bug and several smaller bugs.  Shrank dialog boxes and
buttons due to popular demand.  Added disk offer to registration information.
...
### Directory of PC-SIG Library Disk #3824

     Volume in drive A has no label
     Directory of A:\

    WUNA     ZIP    133027   8-03-93   6:21a
