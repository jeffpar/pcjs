...
{% raw %}
```
                NeoPaint Font Collection #1
          ---------------------------------------
          (C)1992 OSCS Software Development, Inc.

To use these fonts with NeoPaint, simply copy them into your
NeoPaint directory. NeoPaint will automatically detect that
they exist and display them in the font selection dialog box.

To remove unwanted fonts, simply delete the appropriate *.GFT
files.
