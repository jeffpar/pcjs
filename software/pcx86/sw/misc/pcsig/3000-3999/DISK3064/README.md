...
```
Disk No: 3064                                                           
Disk Title: Laser Chess                                                 
PC-SIG Version: S1                                                      
                                                                        
Program Title: Laser Chess                                              
Author Version: 2.0                                                     
Author Registration: None, but source code can be purchased for $50.    
Special Requirements: 640K RAM and EGA graphics.                        
                                                                        
LASER CHESS is a "Star Wars" version of the ancient game of chess. It's 
the same as classic chess but with two notable exceptions: You have an  
additional piece called a Laser that actually shoots a laser to destroy 
other pieces (you can of course "capture" pieces in the traditional     
manner). The other difference is that certain pieces have mirrors or    
reflective properties and can bounce the laser beams in different, but  
predictable, directions. This way you can create complex laser shots    
using friendly and hostile pieces. And you thought chess was complex!   
LASER CHESS is a neat idea with great graphics.                         
...
```
╔═════════════════════════════════════════════════════════════════════════╗
║               <<<<  PC-SIG Disk #3055  LASER CHESS  >>>>                ║
╠═════════════════════════════════════════════════════════════════════════╣
║                                                                         ║
║ To print the program documentation, type: COPY README PRN  (Enter)      ║
║                                                                         ║
║ To start the program, type:  LASER  (press Enter)                       ║
║                                                                         ║
║                                                                         ║
