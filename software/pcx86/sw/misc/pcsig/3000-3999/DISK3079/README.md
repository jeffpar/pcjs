...
{% raw %}
```
		THE COLOR PREFERENCE ANALYSIS TEST
		----------------------------------
Installation:

    1. Copy COLORTST.EXE to your hard drive as follows. 
       At the DOS prompt (C:\>) type the following: 
	COPY A:\COLORTST.EXE C:\WINDOWS

       [Or if you'd rather, use Windows File Manager:
	Start Windows 3.0.  Then start File Manager 
	(it's in the 'Main' group). Click on the picture 
	of Drive A, then double-click on the A:\ folder 
	picture. Now at the Program Manager menu click
	on File, then Copy. At 'To:' click inside the
	text box then type:  C:\WINDOWS 
        Click 'Copy'. Now go to step 3. below.]
    
    2. Start Windows 3.0. 

    3. Select a group to put your new program in.
       To select a group, merely click the mouse anywhere
       inside of the chosen group (such as Accessories).	

    4. At the Program Manager menu, click on File, then New,
       then Program Item and OK.

    5. At 'Description', type:  Color Test
       Hit the tab key and then at 'Command Line' type:
        C:\WINDOWS\COLORTST.EXE

    6. Click OK. Now look for the Color Test icon at the bottom of the 
       group you selected (perhaps Accessories).


    Instructions for operating the Color Test are
    displayed within the program itself.
```
{% endraw %}
...
```
Disk No: 3079
Disk Title: IQ Test & Color Test for Windows
PC-SIG Version: S1.0

Program Title: IQ Test for Windows
Author Version: 2.0
Author Registration: $15.00
Special Requirements: Windows 3.0.

If you're like most people, you're curious about your IQ, but you just
don't know it. Now, if you have 30 minutes and IQ TEST, you can find
out. IQ TEST gives the test, but don't spend too much time on any one
of the 50 questions because at the end of 30 minutes you're done. IQ
TEST will then calculate your IQ with reasonable accuracy. Registered
users of IQ TEST include several colleges and universities.

Program Title: Color Test for Windows
Author Version: 2.0
Author Registration: $15.00
Special Requirements: Windows 3.0.

Available now as a shareware product is the Color Preference Analysis
Test. The principle of the COLOR TEST is that psychological information
can be gained about you through your preferences for colors. The program
asks the user to select preferred colors from a palette. Then based on
those selections, a computerized psychological analysis generates an
enlightening personality description. Unlike other color tests, this
version is aimed at "normal" people rather than at people with severe
psychological problems and is thus appropriate for use as an
entertainment product. Try this one on your friends, family, and fellow
employees. Extremely easy to use, a lot of fun, and just a little scary!
...
Installation:
    ...
    1. Copy IQTEST.EXE to your hard drive as follows. 
       At the DOS prompt (C:\>) type the following: 
	COPY A:\IQTEST.EXE C:\WINDOWS
    ...
    5. At 'Description', type:  IQ Test
       Hit the tab key and then at 'Command Line' type:
        C:\WINDOWS\IQTEST.EXE

    6. Click OK. Now look for the IQ icon at the bottom of the 
       group you selected (perhaps Accessories).


    Instructions for operating the IQ Test are
    displayed within the program itself.
```
{% endraw %}
