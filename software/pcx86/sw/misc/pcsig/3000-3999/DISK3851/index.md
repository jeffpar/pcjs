---
layout: page
title: "PC-SIG Diskette Library (Disk #3851)"
permalink: /software/pcx86/sw/misc/pcsig/3000-3999/DISK3851/
machines:
  - id: ibm5170
    type: pcx86
 ...
 **************************************************************************
 The GrabIt Pro ZIP (GRBPRO.ZIP) file is in PKZIP 1.10 format. Please
 leave it in 1.10 ZIP format so users who don't have version 2.04 will be
 able to extract it.  Thank You!
 **************************************************************************


 The GrabIt Pro Program Files
 --------------------------------- 
 The GrabIt Pro program files are in compressed format. You must run the
 GPSETUP program to expand them before the program can be used.  The
 setup program will create a Program Manager group and add the program
 files and other important files to the group.   

 PLEASE NOTE:
 ------------
 You must run GPSETUP.EXE from the Windows Program Manager.  Other shells
 ...
 the GrabIt Pro Group.

 Step 1
 Running The GPSETUP Program
 ----------------------------
After extracting the GRABPRO.ZIP file to either a directory on your hard drive
...
Program Manager is running.
 ...
 2. Enter the location of the GPSETUP Program. If the files were on your
    A: drive then you would enter: A:\GPSETUP and press Enter or Click on
    the OK button.
 3. The GrabIt Pro setup dialog will be displayed.
...
Currently the manual is up to date and there have been no revisions
or bugs reported at all with version 3.01 since its release in September of
1992

Be sure to read the MANUAL.TXT file, this is the program manual.

Any questions or bug reports should be directed to:

 Software Excellence By Design Inc.
 15414 North 7th Street
 #8 Suite 292
...
including GrabIt.  The same programmers that brought you some of the
first and best Shareware for Windows are back!  GrabIt Pro represents
...
### Directory of PC-SIG Library Disk #3851

     Volume in drive A has no label
     Directory of A:\

    README   TXT      3628   5-28-93   9:54a
    GRABPRO  ZIP    153857   7-09-93   3:45p
