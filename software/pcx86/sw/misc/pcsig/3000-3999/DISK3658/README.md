---
layout: page
title: "PC-SIG Diskette Library (Disk #3658)"
permalink: /software/pcx86/sw/misc/pcsig/3000-3999/DISK3658/
machines:
  - id: ibm5170
    type: pcx86
...
```
                          ...
                          MAXimize Utilities, Version 3.1a
                          ================================
     ...
     This is the usage log report, license control and conversion utilities 
     for the MAXimize products - the Gold and Basic editions.  These products 
     can be found in files:

             MAXGLD31.ZIP  --> The Gold edition of MAXimize
             MAXBAS31.ZIP  --> The Basic edition of MAXimize

     If you are unable to locate either of these files, you may request them
     by sending $5 to the address above.  Be sure to include which file(s) you
     are interested in and your address.

     
     Installation:
     =============

     Unpack the MAXUTL31.EXE file into the directory containing MAXimize Gold 
     or Basic edition.
     ...
     (LANs), including usage logging and check in/out capabilities.
```
{% endraw %}
...
### Directory of PC-SIG Library Disk #3658

     Volume in drive A has no label
     Directory of A:\

    README   TXT      2615  11-25-92  10:55p
    MAXUTILS ZIP    175120   6-22-93   2:11p
