---
layout: page
title: "PC-SIG Diskette Library (Disk #3853)"
permalink: /software/pcx86/sw/misc/pcsig/3000-3999/DISK3853/
machines:
  - id: ibm5170
    type: pcx86
...
```
-----------------------------------------------------------------
README.TXT              Accounts Receivable              09/08/93
-----------------------------------------------------------------

This file consists of three pages and covers the following:
...
-----------------------------------------------------------------
Cribsheet Software, 4455 Torrance Blvd Ste 273, Torrance CA 90503
-----------------------------------------------------------------
```
{% endraw %}
...
### Directory of PC-SIG Library Disk #3853
    ...
    AR       ZIP    263898  11-24-93  11:04a
            9 file(s)     311339 bytes
                            6144 bytes free
