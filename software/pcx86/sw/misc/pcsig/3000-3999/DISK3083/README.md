...
```
        ...
        Dear ASP Distributor,

             Please evaluate CM_FILER Ver 5.22 for inclusion in your
        library.   If you have listed any previous version, please
        replace it with the enclosed.

             CM_FILER is unique in the degree to which it consolidates
        disk and directory services into a single small, fast program
        with an intuitive user command environment.  Some of my users
        proclaim it the best file manager available today.

             The CM_FILER five-file set consists of the program file
        CM_FILER.COM and its companion overlay CM_FILER.OVY; the user's
        manual CM_FILER.DOC; the registration information CM_FILER.REG;
        and a two-page brief description of its commands CM_FILER.BRF.

             You may choose between two packages of these five files,
        both of which were compressed with the PKWARE PKZIP utility,
        depending on your storage/transmission requirements and your
        users' access to the PKZIP utilities.  The self-extracting
        package is bigger, but does not require the user to have PKUNZIP.

             Any alternative package you wish to distribute is acceptable
        as long as it includes unaltered all five files (CM_FILER.COM,
        .OVY, .DOC, .REG and .BRF).

             The proposed writeup below should be suitable for inclusion
        in your listings, and emphasizes the features I believe make
        CM_FILER a most powerful file manager.  Please let me know your
        intention to list so that I may keep you up to date with
        revisions.

                                                Sincerely,

                                                Charles F. Martin, ASP
                                                President, NoVaSoft
                                                3239 Riverview Dr.
                                                Triangle, VA  22172-1421

                                                Ph 703-221-1471/221-1833
                                                CompuServe 72130,1400


        -----------------------------------------------------------------

        CM_FILER Version 5.22  . . . . . . . . . .  C. F. Martin, ASP

        CM_FILER 5.22 is a small, fast, powerful file manager featuring
        side-by-side display of file listings OR directory trees, full
        suite of file and directory services, built-in editor, print
        spooler, file finder, file notepad, application launcher, access
        denial, recovery of files after unintended deletion, and MUCH
        more.  Tree module is not just a display, but offers services to
        copy, move, delete individual directories or entire directory
        structures with same ease as file services module does for
        individual files.  Transparent architecture, intuitive one-touch
        mnemonic commands and extra convenience features, such as a one-
        stroke directory freshener, make CM_FILER the most versatile file
        manager in the shareware market today.  For beginners and
        developers alike.  Only requires DOS v.2 or higher, 182 KB
        available memory.
