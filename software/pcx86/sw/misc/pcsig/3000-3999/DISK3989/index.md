---
layout: page
title: "PC-SIG Diskette Library (Disk #3989)"
permalink: /software/pcx86/sw/misc/pcsig/3000-3999/DISK3989/
machines:
  - id: ibm5170
    type: pcx86
...
{% raw %}
```
                College Funding Finder (TM)
             (C) Copyright 1991-1993, INFOSOFT
                    All Rights Reserved.

 ABOUT COLLEGE FUNDING FINDER

     College Funding Finder is an alternative student financial
 aid database which tracks over 1,400 alternative student
 financial aid sources offering over 50,000 different student
 financial aid programs including scholarships, grants, low-
 interest loans, no-interest loans, fellowships and internships.  
 In addition to helping students locate sources of financial 
 aid, College Funding Finder provides the student with 
 comprehensive funding information AND personalized application 
 request letters which reduce the effort required by the student 
 to get the necessary applications for these aid programs.  A 
 guide with tips for applying to these funds is also supplied 
 to the student.
     College Funding Finder is intended for use by anyone 
 planning on paying for an education whether it is trade school,
 college, graduate school or academic research.  There are even
 programs for high school students in College Funding Finder's
 database.
     College Funding Finder is THE ONLY financial aid search 
 software made available to the public.  Other similar systems 
 are sold solely to educational institutions and range in cost 
 from $400 per year up to $3,500 per year and are not as user-
 friendly.  
     College Funding Finder is also endorsed by the University 
 of San Diego's Copely Library and John Hancock Financial 
 Services of San Diego, CA.
     
 HARDWARE REQUIREMENTS

     College Funding Finder requires an 80286 machine or better
 with at least 256k of RAM, a monochrome video card, a hard disk
 drive with at least 500k of space available and DOS Version 2.0 
 or higher.
 
 INSTALLATION

     Place the College Funding Finder diskette in any disk drive.
 At the drive's prompt [EX. 'A:\'] type:

 'INSTALL [drive letter]:'

 where drive letter is the letter of the hard disk you wish to 
 install to.  For example,

 'INSTALL C:'

 will install College Funding Finder on the 'C:' hard drive.
     College Funding Finder's files are compressed and will
 take a few moments to expand.  The installation program will
 create the 'CFF' subdirectory on your hard disk.  It will 
 place College Funding Finder's data and program files into
 that subdirectory.  Once in the 'CFF' subdirectory, type
 'CFF' followed by 'ENTER' to run College Funding Finder.

 REGISTRATION FEES

     This is the SHAREWARE version of College Funding Finder.  
 Due to data storage restrictions, this version contains only 
 165 financial aid sources.  If you wish to register your use 
 of this program and receive the expanded, 50,000 scholarship 
 version please mail your return-address information and the 
 appropriate registration fee to INFOSOFT's main address.  
 College Funding Finder will print out an invoice with such 
 information if you have a printer connected to your computer.  
 Also please indicate if you have a 5 1/4" disk drive on your 
 computer.

 Institutional registration fee (MANY USERS, ONE MACHINE) = $250.00
 Individual registration fee (ONE USER, ONE MACHINE)      = $ 39.95

 NOTE: California purchasers must include state sales tax of 7.75% 
 of the total price. State sales tax is subject to regular changes, 
 so please include the proper amount of tax if currently different 
 from 7.75%.
                             MAIL TO:
     ...
     Upon verification of your payment, you will immediately be sent 
 the expanded 50,000 scholarship version of College Funding Finder 
 with the most current financial aid information.  The expanded 
 version includes financial aid based upon a student's personal 
 background information including sex, ethnic origin, religious 
 affiliation, armed forces affiliation, handicaps/disabilities, 
 fraternity/sorority affiliations, organization memberships, and 
 much, much more.
      A printed manual and future update information will also be 
 ...
 LIST OF PROGRAM FILES
     ...
     This diskette should contain three (3) program files.  They
 are:

 FILENAME             DESCRIPTION
 -----------------------------------------------------------------
 INSTALL.BAT          College Funding Finder Installation program
 CFFSHR.EXE           College Funding Finder self-extracting file
 READ.ME              College Funding Finder instructions

     When extracted, CFFSHR.EXE should give you the following 
 files:

 FILENAME             DESCRIPTION
 -----------------------------------------------------------------
 CFF.EXE              College Funding Finder program
 FUND.DAT             College Funding Finder financial aid data
 CFF3SHR.CFF          College Funding Finder program help file

 GOOD LUCK!

     INFOSOFT wishes all students the best of luck in their
 efforts to make their college education more affordable.
 INFOSOFT is dedicated to promoting a student's pursuit of
 a college education.
     Should you have any additional questions, comments or 
 suggestions, please feel free to contact INFOSOFT at our
...
### Directory of PC-SIG Library Disk #3989
    ...
    CFF      ZIP    181916   8-24-93   1:49p
            9 file(s)     256885 bytes
                           60416 bytes free
