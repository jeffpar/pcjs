---
layout: page
title: "PC-SIG Diskette Library (Disk #3098)"
permalink: /software/pcx86/sw/misc/pcsig/3000-3999/DISK3098/
machines:
  - id: ibm5170
    type: pcx86
...
```
Disk No: 3098                                                           
Disk Title: VB Icon Browser & Extractor                                 
PC-SIG Version: S1.0                                                    
                                                                        
Program Title: VB Icon Browser                                          
Author Version: 2.0                                                     
Author Registration: $19.95                                             
Special Requirements: Windows 3.x.                                      
                                                                        
VP ICON BROWSER gives you a simple way to view, maintain, and print     
Windows icons. With drag-and-drop ease, you can view, copy, rename, and 
delete icons. VB ICON BROWSER really excels at printing. With it, you   
can print out one to 1,000 icons per page by varying titles, margins,   
and spacing. VP ICON BROWSER uses Windows to help you manage your       
Windows icons.                                                          
                                                                        
Program Title: VB Icon Extractor                                        
Author Version: 1.11                                                    
Author Registration: $14.95                                             
Special Requirements: Windows 3.x.                                      
                                                                        
The VB ICON EXTRACTOR is a clever little program that will extract icons
that are embedded in Windows.EXE or .DDL files. As it extracts them, it 
converts them to .ICO format. Once they are in .ICO format, they can be 
edited and customized by a number of different icon editing programs.   
The altered icons then can replace the program's original icons on your 
Windows desktop or be used for other purposes. A great idea!            
...
Company: __________________________            ____________________________
 ...
 P.O. #: __________________________       Fax: ____________________________

Where did you obtain this product from? ___________________________________

Qty   Description                                        Price     Extended
---   ------------------------------------------------   -------   --------
      Latest version of VB ICON BROWSER for
___   Windows 3.x.  Includes Visual Basic forms,         $ 19.95   ________
      source code, and 250 free icons.
---------------------------------------------------------------------------
      Latest version of VB ICON EXTRACTOR for
___   Windows 3.x.  Includes Visual Basic forms,         $ 14.95   ________
      source code, and 250 free icons.
---------------------------------------------------------------------------
      Latest version of the REGISTERED LAN/BBS
___   TOURNAMENT GOLF software.                          $ 19.95   ________
---------------------------------------------------------------------------
      LAN/BBS Tournament Golf COURSES DISK
___   Each disk contains several courses.                $  4.95   ________
---------------------------------------------------------------------------
      LAN/BBS Tournament Golf Utilities
___   QUICKBASIC SOURCE CODE.                            $  9.95   ________
---------------------------------------------------------------------------
      LATEST VB ICON BROWSER AND VB ICON EXTRACTOR
___   WITH SOURCE AND ICONS SPECIAL OFFER                $ 24.95   ________
---------------------------------------------------------------------------
    * LATEST VB ICON BROWSER, VB ICON EXTRACTOR, AND *
___ * REGISTERED LAN/BBS TOURNAMENT GOLF MEGA OFFER  *   $ 29.95   ________
---------------------------------------------------------------------------
      LAN/BBS TOURNAMENT GOLF MONTHLY UPGRADE
___   LBGolf is just getting started!                    $  2.95   ________
---------------------------------------------------------------------------
      VB ICON BROWSER MONTHLY UPGRADE
___   Several planned new features!                      $  2.95   ________
---------------------------------------------------------------------------
                                                 |
       PLEASE SPECIFY THE DISK FORMAT!           |      SUBTOTAL $ ________
                                                 |
___ 5 1/4" DD (360K)     ___ 5 1/4" HD (1.2M)    |      TAX      $ ________
                                                 |
___ 3 1/2" DD (720K)     ___ 3 1/2" HD (1.44M)   |      TOTAL    $ ________
...
### Directory of PC-SIG Library Disk #3098

     Volume in drive A has no label
     Directory of A:\

    VBICON   ZIP    232223   8-25-92   4:26p
    CDROM    TXT      3972   6-24-92   1:25p
    GO-FORM  DAT      3109   6-29-92   3:26p
    GO-STRT  DAT       545   8-25-92   4:30p
    GO       EXE     26022   1-10-92  12:14p
    PCSIG    TXT      2335   1-21-92   6:09a
    PKUNZIP  EXE     23528   3-15-90   1:10a
    SHAREMAG TXT      1837   1-21-92   6:11a
    SIGORDER TXT      3332   6-25-92   2:28p
    FILE3098 TXT      2443   8-26-92  12:36p
           10 file(s)     299346 bytes
                           18432 bytes free
