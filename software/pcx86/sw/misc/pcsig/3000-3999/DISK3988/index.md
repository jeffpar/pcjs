---
layout: page
title: "PC-SIG Diskette Library (Disk #3988)"
permalink: /software/pcx86/sw/misc/pcsig/3000-3999/DISK3988/
machines:
  - id: ibm5170
    type: pcx86
...
Following are the system requirements:
	...
	2) Windows 3.1 or higher
	3) Windows operating in standard or enhanced mode
	4) Mouse or other pointing device
	5) Digital audio highly recommended (Soundblaster) or speaker driver

This software is shareware.  This software is NOT free.  If you like the 
program and continue to use it, you MUST register the program.  
Registration Fee: $10.95 U.S.
	BFM Software
	Brett McDonald
	20278 Old Homestead
...
### Directory of PC-SIG Library Disk #3988

     Volume in drive A has no label
     Directory of A:\

    WINSLOT  ZIP    120308   8-20-93   3:31p
