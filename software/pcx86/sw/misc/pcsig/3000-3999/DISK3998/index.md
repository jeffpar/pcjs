---
layout: page
title: "PC-SIG Diskette Library (Disk #3998)"
permalink: /software/pcx86/sw/misc/pcsig/3000-3999/DISK3998/
machines:
  - id: ibm5170
    type: pcx86
...
/**** Googolpede for Windows V1.4 - Preliminary Documentation ****/
...
/**** System Requirements ****/
      ...
      > Computer running Windows V3.1.
      > At least 1 meg FREE memory.
      > EGA or higher color monitor.
      > A mouse.

/**** Getting Started ****/

      At this point, you should have five new files in a temporary directory
      on your hard disk. These must be moved to their proper locations, and
      then you can get back into Windows and run the program.

      Here is the file list, with their proper locations:

              GOOGOL-1.EXE .... \WINDOWS
                GOOGOL.FRM .... \WINDOWS
                GOOGOL.TXT .... \WINDOWS
              VBRUN200.DLL .... \WINDOWS\SYSTEM
                THREED.VBX .... \WINDOWS\SYSTEM

      You can use File Manager to move the files around, or the DOS COPY
      command, whichever is easiest for you!

      Once these five files are in the correct directories, you can run
      the program. Just double-click on the EXE file from File Manager.

/**** Making a Program Manager Icon ****/

      It's very easy to create a icon in Program Manager. This technique
      works for Googolpede and almost any other program.

      Just open up File Manager and Program Manager at the same time. Select
      the EXE file in the file list, by clicking on it once. Now, hold down
      the mouse button and drag it over to Program Manager. Then let go!

      That's all there is to it. There will be a new icon in Program Manager,
      and you can double-click on it to start the program!

/**** Googolpede Help ****/

      This preliminary version doesn't have much documentation, but there
      are several help screens in the program. Anytime you see a button with
      a question mark "?" on it, just click it to see that help screen!
...
### Directory of PC-SIG Library Disk #3998

     Volume in drive A has no label
     Directory of A:\

    GOOGOL   ZIP    276099   8-25-93   5:08p
