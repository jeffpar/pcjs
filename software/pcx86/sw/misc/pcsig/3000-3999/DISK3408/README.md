...
{% raw %}
```
Welcome to Look and Listen A,B,C...
Registration Fee: $9.95 ($39.80 for all 7 Look and Listen 
    ...
    Send to: Attn: Look and Listen Registration
             ...
             Redmond, WA 98052
             (206) 861-5463
Look and Listen A,B,C... includes InWin: an install
...
NOTE: Most files in this program are compressed and MUST
      ...
      about 2 minutes for the install.
...
Step #4: Type:   A:INSTALL   or    B:INSTALL
         ...
         on the screen.
Step #5: After the Install is completed, double click the
...
{% raw %}
```
Look and Listen A,B,C...                             VENDOR.DOC
               
       D I S K  V E N D O R   I N F O R M A T I O N
       --------------------------------------------
  This file provides information for disk vendors who wish to
distribute Look and Listen A,B,C... via their disk duplication
and distribution services.  If you wish to distribute Look and
Listen A,B,C... and other Softline programs, then call or write
to the Softline address given below.  If approved, Softline will
send master distribution diskettes of each shareware version.
				Softline, Inc. - ASAD Member
------------------------------------------------------------------
Look and Listen A,B,C...: Educational program in Windows for
                          pre-schoolers (A through Z).
------------------------------------------------------------------

TITLE: Look and Listen A,B,C...,  Version 5.0
...
TOTAL of File Sizes: 322,287 bytes (Diskette #1)
		     110,585 bytes (Diskette #2)
...
------------------------------------------------------------------
  HOW TO INSTALL Look and Listen A,B,C...
...
etc..
     ...
     Look and Listen A,B,C... - Short Description:

        Look and Listen A,B,C..., Version 5.0	   $9.95
        ...
        or installed sound device in Windows!.  Teach that
        young mind from A to Z. 
     ...
     Look and Listen A,B,C... - Long Description:

        Look and Listen A,B,C..., Version 5.0      $9.95

        Look and Listen A,B,C... is an educational picture and
        sound program that takes advantage of the existing
        computer speaker or installed sound device.  Grab your
        pre-schooler's attention with colorful pictures and fun
        sounds!.  Teach your kids the A,B,C's and introduce
...
Listen A,B,C... produced by Softline, Inc..  Look and Listen
A,B,C... and its' associated files, documentation, and help files
are NOT in the public domain.  Look and Listen A,B,C... is owned
by Softline, Inc., Redmond, WA., U.S.A., the copyright holder.
Look and Listen A,B,C... is a trademark of Softline, Inc..
...
and are outlined below.
    ...
    - No organization may sell the Shareware versions of Look and
      Listen A,B,C... without prior written permission from
...
distribute Look and Listen A,B,C....  If you are already a member
...
You may distribute Look and Listen A,B,C... products on the
following terms:
- Look and Listen A,B,C..., when listed in vendors' catalogues,
  advertisements, brochures, mailers, etc. must be named
  "Look and Listen A,B,C...".

- Look and Listen A,B,C... may NOT be sold as part of some other
  more inclusive package without a license from Softline, Inc..

- Look and Listen A,B,C... must not be distributed with other
  Shareware or public domain programs on the same floppy disk
  without permission from Softline, Inc..  However, Look and
  Listen A,B,C... may be included in libraries sold on CD-ROM
...
- Look and Listen A,B,C... - including all related program files
...
- No price or other compensation may be charged for Look and
  Listen A,B,C.... A reasonable distribution cost may be charged
  for the cost of the diskette plus shipping and handling.

- Look and Listen A,B,C... CANNOT be sold as part of some other
  ...
  A,B,C... be "rented" or leased to others.

- Any distribution of Look and Listen A,B,C... over bulletin
...
------------------------------------------------------------------
VENDOR STANDARDS:
  In order to distribute Look and Listen A,B,C... you must agree
...
Listen A,B,C..., Softline, Inc. will forward a Vendor Master
Distribution disk.  Updates will be offered to approved
organizations on a case-by-case basis.

     Look and Listen A,B,C... produced by Softline, Inc.
     ---------------------------------------------------
   Look and Listen A,B,C... is a trademark of Softline,Inc.
...
VENDOR.DOC                              Look and Listen A,B,C...
```
{% endraw %}
