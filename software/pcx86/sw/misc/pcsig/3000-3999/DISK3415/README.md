...
{% raw %}
```
Welcome to Look and Listen Shapes
Registration Fee: $9.95 ($39.80 for all 7 Look and Listen 
    ...
    Send to: Attn: Look and Listen Registration
             ...
             Redmond, WA 98052
             (206) 861-5463
Look and Listen Shapes includes InWin: an install
...
------------------------------------------------------------------
Look and Listen Shapes - Educational program in Windows for
                         pre-schoolers (Shapes).
------------------------------------------------------------------

TITLE: Look and Listen Shapes,  Version 5.0
...
TOTAL of File Sizes: 294,491 bytes
...
------------------------------------------------------------------
  HOW TO INSTALL Look and Listen Shapes
...
Registration Fee: $9.95 ($39.80 for all 7 Look and Listen 
    ...
    Send to: Attn: Look and Listen Registration
             ...
             Redmond, WA 98052
             (206) 861-5463
Look and Listen Shapes includes InWin: an install program
...
etc..
     ...
     Look and Listen Shapes - Short Description:

        Look and Listen Shapes, Version 5.0 - $9.95
        ...
        that young mind how to identify various geometric
        shapes.
     ...
     Look and Listen Shapes - Long Description:

        Look and Listen Shapes, Version 5.0 - $9.95

        Look and Listen Shapes is an educational picture and
        ...
        goemetric shapes and introduce them to a computer at
        the same time.  Have loads of fun with re-coloring
        the pictures within Windows Paint.  Sound Off, Loop
        and Delay are handy features for testing and teaching.
        Easy auto install program, run from within Windows,
        is included.
        Passed: Microsoft Compatibility for Windows testing.
        Requires: Microsoft Windows 3.0 or 3.1 (Standard or
                  Enhanced modes), operates through the PC
...
Listen Shapes produced by Softline, Inc..  Look and Listen
Shapes and its' associated files, documentation, and help files
are NOT in the public domain.  Look and Listen Shapes is owned
by Softline, Inc., Redmond, WA., U.S.A., the copyright holder.
Look and Listen Shapes is a trademark of Softline, Inc..
Distribution restriction rights are claimed under that copyright
and are outlined below.

    - No organization may sell the Shareware versions of Look and
      Listen Shapes without prior written permission from
      Softline, Inc..  To apply for such permission send a written
      request to:
         Softline, Inc. 
...
distribute Look and Listen Shapes.  If you are already a member
of ASP or ASAD, please mention it in your request for
...
You may distribute Look and Listen Shapes products on the
following terms:
- Look and Listen Shapes, when listed in vendors' catalogues,
  advertisements, brochures, mailers, etc. must be named
  "Look and Listen Shapes".

- Look and Listen Shapes may NOT be sold as part of some other
  more inclusive package without a license from Softline, Inc..

- Look and Listen Shapes must not be distributed with other
  Shareware or public domain programs on the same floppy disk
  without permission from Softline, Inc..  However, Look and
  Listen Shapes may be included in libraries sold on CD-ROM
...
- Look and Listen Shapes - including all related program files
  and documentation files - CANNOT be modified in any way and must
  be distributed as a complete package, without exception.

- No price or other compensation may be charged for Look and
  Listen Shapes. A reasonable distribution cost may be charged
  for the cost of the diskette plus shipping and handling.

- Look and Listen Shapes CANNOT be sold as part of some other
  ...
  Shapes be "rented" or leased to others.

- Any distribution of Look and Listen Shapes over bulletin
...
------------------------------------------------------------------
VENDOR STANDARDS:
  In order to distribute Look and Listen Shapes you must agree
...
Listen Shapes, Softline, Inc. will forward a Vendor Master
Distribution disk.  Updates will be offered to approved
organizations on a case-by-case basis.

     Look and Listen Shapes is produced by Softline, Inc.
     ---------------------------------------------------
    Look and Listen Shapes is a trademark of Softline,Inc.
...
VENDOR.DOC                              Look and Listen Shapes
```
{% endraw %}
