---
layout: page
title: "PC-SIG Diskette Library (Disk #3945)"
permalink: /software/pcx86/sw/misc/pcsig/3000-3999/DISK3945/
machines:
  - id: ibm5170
    type: pcx86
...
The software you are using is the Demo version of Finding A Good Used Vehicle, 
which contains about 1200 used car records from 1983. To receive the software 
FINDING A GOOD USED VEHICLE with 
--COMPLETED USED CAR RECORDS FROM 1978, 
--FREE ANNUAL UPDATED VERSION,
--FREE TECHNICAL SUPPORT and 
--FREE MANUAL IF REQUESTED 
Send registration fee $29.95 to:
...
### Directory of PC-SIG Library Disk #3945

     Volume in drive A has no label
     Directory of A:\

    README   TXT       491   3-28-93   5:08a
    ...
    USEDCAR  ZIP    213731   8-12-93   9:38a
           10 file(s)     289191 bytes
                           27648 bytes free
