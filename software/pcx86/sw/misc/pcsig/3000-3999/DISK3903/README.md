---
layout: page
title: "PC-SIG Diskette Library (Disk #3903)"
permalink: /software/pcx86/sw/misc/pcsig/3000-3999/DISK3903/
machines:
  - id: ibm5170
    type: pcx86
...
Gold Monkey Version 1.0

Gold Monkey is an exciting MS-Windows strategy game! Use all your wits
as you try to fill the screen with bananas by clicking on the correct 
number. It is simple to learn and play, but only the craftiest will 
be a Top Banana! Can you beat the Top 5? Can you beat your friend's 
best? Can you cruise the diagonals with finesse? Beware of this 
colorful, addictive logic test by Gold Software.
...
Welcome to Gold Monkey by Gold Software.

Gold Monkey is a great, addictive strategy game.

It is a shareware product, which means you should pass this game around
to ALL your friends who own or use Windows. If you like the game, you must
send $5 to:
...
If the only file you have is gmonkey.zip, then you need to do 'PKunzip gmonkey'
after copying the .zip file to your hard disk. Then follow the instructions 
below.

To Install the program:

  1. You must be running MS-Windows 3.0 or higher.

  2. Mouse click the Program Manager 'File' menu option.

  3. Mouse click the 'Run' option, then type a:setup or b:setup depending
     on which disk drive the install disk is in.

  4. Follow the instructions in the setup program.

To Run the program:

  1. Double click on the Gold Monkey icon in the Games group of Program 
     Manager.

  2. The object of the game is to fill the screen with bananas. 
     You click on any number next to the green banana, and that many 
     spaces will turn into a banana. Remember to always click by the 
     GREEN banana.
	
  3. If you cross another banana, hit a red spider, or hit the edge, 
     you will lose. The game will restart , giving you another chance 
     at victory (that is, a higher score).
	
  4. See the top 5 high scores by mouse-clicking the 'Help' menu option 
     and mouse-clicking 'Top Bananas'.

Known problems
  1. You must have a Games group in your Program Manager window, or 
     the setup program will not place Gold Monkey in a Program Manager 
     group.
	
  2. Gold Monkey will not work correctly on systems with graphics cards 
     that support 32,000 colors.


Thank you and ..... Eeee Eeee Oooo Oooo  (Have fun)


DISCLAIMER OF WARRANTY

THIS SOFTWARE IS PROVIDED "AS IS" AND IS WITHOUT WARRANTIES AS TO ITS 
...
PROGRAM MAY BE PLACED, NO WARRANTY OF FITNESS FOR A PARTICULAR PURPOSE IS 
OFFERED. THE USER MUST ASSUME THE ENTIRE RISK OF USING THE PROGRAM.  
GOLD SOFTWARE WILL  NOT BE HELD LIABLE FOR ANY ADVERSE EFFECTS OR 
CONSEQUENCES OF PROGRAM USE.

Note: Windows and MS-Windows are registered trademarks of Microsoft Corporation 
in the U.S.A. and other countries. PKunzip is a registered trademark of PKware.
```
{% endraw %}
...
### Directory of PC-SIG Library Disk #3903
    ...
    README   TXT      2503   6-27-93   1:55a
    PCSIG    TXT      2329   6-01-93   2:31p
    SHAREMAG TXT      1831   6-01-93   2:32p
    CDROM    TXT      8196   6-01-93   3:26p
    MONKEY   ZIP    247954   8-11-93   1:02p
           10 file(s)     325426 bytes
                           30720 bytes free
