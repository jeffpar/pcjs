...
```
    ...
    FLOPPY DISK USERS:  1. READ THE FILE  -  READ-ME.1ST  (VERY IMPORTANT)
                        ...
                        2. TYPE "GO" AND HIT "ENTER"
                           ...
                           B. START FLIP-N-DROP (C)         - FLIP.EXE
...
```
  ...
  |                                                                          |
  |        F L I P - N - D R O P    R E G I S T R A T I O N   F O R M        |
  |                                                                          |
  |                               VERSION  1.0                               |
  |__________________________________________________________________________|
  ...
  |    for your enjoyment.                                                   |
  |                                                                          |
  |    As mentioned in READ-ME.EXE, as a Registered User, you will be en-    |
  |    titled to the first major upgrade of this fine Software.  This new    |
  |    revision will be sent to you, "FREE OF CHARGE."                       |
  |                                                                          |
