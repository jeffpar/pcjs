---
layout: page
title: "PC-SIG Diskette Library (Disk #3493)"
permalink: /software/pcx86/sw/misc/pcsig/3000-3999/DISK3493/
machines:
  - id: ibm5170
    type: pcx86
...
{% raw %}
```
This ist the first of three Graphics Libraries for the Printshop 
...
are named "graphic4.*" thru "graphic6.*".
...
{% raw %}
```
This is the second of three Graphics Libraries for the Printshop 
converted from disks of public-domain Apple-version graphics 
distributed by the Big Red Apple Club.
...
### Directory of PC-SIG Library Disk #3493

     Volume in drive A has no label
     Directory of A:\

    PSI      ZIP     58951   4-05-93   3:59p
    ...
    PSII     ZIP    150381   4-05-93   4:00p
           10 file(s)     274648 bytes
                           43008 bytes free
