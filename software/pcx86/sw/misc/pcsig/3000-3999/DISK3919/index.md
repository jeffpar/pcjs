---
layout: page
title: "PC-SIG Diskette Library (Disk #3919)"
permalink: /software/pcx86/sw/misc/pcsig/3000-3999/DISK3919/
machines:
  - id: ibm5170
    type: pcx86
...
VGA/SUPER-VGA MAHJONGG!! STUNNING GRAPHICS!! LOADS OF OPTIONS!! MUST SEE!!
VGA/SUPER-VGA MAHJONGG!! STUNNING GRAPHICS!! LOADS OF OPTIONS!!
VGA/SUPER-VGA MAHJONGG!! STUNNING GRAPHICS!! MUST SEE!
VGA/SUPER-VGA MAHJONGG!! STUNNING GRAPHICS!!
VGA/SUPER-VGA MAHJONGG!! STUNNING!!
...
graphics, as well as Hercules, CGA, EGA, and regular VGA.
	Contains several incredible tile sets, including the incredible Moraff's
World monsters. For those with 256 colors, it has an animated rainbow tile set
that can be used independently or as background for any other set of images.
	This may well be Moraff's best game yet, if you like relaxing but
challenging games!
NOW CONTAINS MEGA MOREJONGG, THE ULTIMATE MOUNTAINOUS MAHJONGG LAYOUT!
```
{% endraw %}
...
You've lucked into a copy of Moraff's Morejongg, Version 3.0! Please play and
 enjoy this game and make many copies for all of your friends. Shareware
 programs are supported by those who use and pay for them. Past support has
 enabled the developement of our incredible line of super high-res games.

Feel free to distribute copies of this game in any of the following ways:
   1) Placing the complete program on bulletin boards.
...
Type `MOREJONG' to start this game.


All instructions are built into this program's help files.

Our toll-free order line is 800-VGA-GAME.

MoraffWare is seeking official support BBS's. If you have a BBS call us and
  we'll send you the latest shareware for your board, free of charge! Examine
  the file UPLOAD.TXT for listing descriptions.
...
### Directory of PC-SIG Library Disk #3919

     Volume in drive A has no label
     Directory of A:\

    README   TXT       960   8-11-93   3:01p
    MOREJONG ZIP    244268   8-11-93   2:59p
