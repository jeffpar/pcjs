---
layout: page
title: "PC-SIG Diskette Library (Disk #3961)"
permalink: /software/pcx86/sw/misc/pcsig/3000-3999/DISK3961/
machines:
  - id: ibm5170
    type: pcx86
...
Registration and the REGISTER Program

For information on how to register DOS Phantom, see the file
ORDER.FRM.

The REGISTER program included in this shareware kit is used after
you have received your Product Registration Key (PRK) from P2
Enterprises.  Your PRK is assigned and mailed to you via U.S. 
Mail (or CompuServe mail if you prefer) when P2 Enterprises
receives your registration fee. 

The advantage of this method of registration is that you may use
your PRK to register future releases of this product without
additional charges or paperwork. 



Using REGISTER

The REGISTER program is really quite easy to use, and you
probably won't need the step-by-step instructions below, but here
they are anyway. 


1.  Set your default directory to the one containing the REGISTER
program and the .EXE files you want to register.  Have your PRK
handy. 

2.  Invoke the program with the command REGISTER.  An initial
welcome screen is displayed.  Press return to continue
registration, or select Exit with the Tab key to quit. 

3.  You will now be instructed to enter your PRK.  Enter it just
as it is shown on your registration letter from P2 Enterprises. 
You may use upper or lower case, but be sure you enter all the
letters and numbers correctly.  (If you make a mistake, the
program will allow you to try again.) If you wish to quit now,
you may press ESC to close the PRK window, and then press Alt-X. 

4.  After you have entered your PRK successfully, you will be
presented with a file selection window.  You may type the
filename of the file you wish to register followed by Enter, or,
by just pressing Enter, select it from the list with the arrow
keys and then press Enter.  If you wish to quit now, you can
press ESC to close the file selection window, and then press
Alt-X. 

5.  If the file you selected is a P2 Enterprises product which
supports this method of registration (all our current products
do), it will be updated with your PRK.  If the file is not a P2
Enterprises product, or if it as a version released before we
introduced REGISTER, a message will be displayed indicating that
the file you selected in not a P2 Enterprises product. 

6.  After registering one file, the file selection window is
again presented so that you can register more files if you wish. 
Press ESC to close the file selection window. 

7.  When no windows are displayed on the REGISTER desktop, you
may press Alt-X to leave REGISTER. 
...
### Directory of PC-SIG Library Disk #3961

     Volume in drive A has no label
     Directory of A:\

    PHANTOM  ZIP    210226   8-12-93   9:13a
