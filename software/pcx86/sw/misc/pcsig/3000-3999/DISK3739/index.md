---
layout: page
title: "PC-SIG Diskette Library (Disk #3739)"
permalink: /software/pcx86/sw/misc/pcsig/3000-3999/DISK3739/
machines:
  - id: ibm5170
    type: pcx86
...
{% raw %}
```
HOW FAST IS THE 386 VERSION?
In the following chart we compare decompression times of various JPEG
images with WinJPEG, Jview, and ColorView for Windows.  The elapsed
times are measured between pressing the OK button in the file selection
dialog and the completion of the display of the image.

-----------+---------------+------------------------------------------------
	   |               +     Decompression Time in Minutes:Seconds
           |               +
           |  JPEG image   +  WinJPEG  |  WinJPEG  |   JView   |  ColorView 
           |               +   v.2.0   |   v.2.0   |   v.0.9   |   v.0.97
           |               +  386 ver. |  286 ver. |  386 ver. |  386 ver.
-----------+---------------+-----------+-----------+-----------+------------
Filename   | mirri3.jpg    +           |           |           |
Resolution | 551x579       +    0:28   |    0:37   |    0:30   |    0:32
Filesize   | 75,754 bytes  +           |           |           |
-----------+---------------+------------------------------------------------
Filename   | mandrill.jpg  +           |           |           |
Resolution | 512x512       +    0:34   |    0:50   |    0:35   |    0:35
Filesize   | 341,656 bytes +           |           |           |
-----------+---------------+------------------------------------------------
Filename   | colrtest.jpg  +           |           |           |
Resolution | 800x600       +    0:36   |    0:45   |    0:38   |    0:45
Filesize   | 67,780 bytes  +           |           |           |
-----------+---------------+-----------+-----------+-----------+------------
Filename   | shali.jpg     +           |           |           |
Resolution | 597x748       +    0:38   |    0:49   |    0:41   |    0:48
Filesize   | 65,155 bytes  +           |           |           |
-----------+---------------+-----------------------------------+------------
Filename   | gef-01.jpg    +           |           |           |
Resolution | 787x530       +    0:44   |    1:05   |    0:47   |    0:59
Filesize   | 162,780 bytes +           |           |           |
-----------+---------------+-----------+------------------------------------

With all 4 programs, the JPEGs were decompressed with 2-pass
quantization and Floyd-Steinberg dithering.  WinJPEG and ColorView were
configured to use available memory instead of temporary files.

These timings were performed on the following system: 
  - 386-40 MHz with 64k cache
  - 16 Mb of RAM, (1 Mb set aside for hard disk cache)
  - Maxtor LXT-200 SCSI-1 drive
  - WD7000FASST SCSI controller
  - Windows 3.1 in 640x480x256 display mode
  - Diamond SpeedStar Plus SVGA card

No other programs except Program Manager were running at the same time
as each of the above programs.  In addition, the disk cache was cleared
between decompression of each set of pictures to obtain more accurate
timings.

JView is a copyright of David Holliday.
Colorview is a copyright of Millennium Technologies Corp.
```
{% endraw %}

{% comment %}samples_end{% endcomment %}

### Directory of PC-SIG Library Disk #3739

     Volume in drive A has no label
     Directory of A:\

    WINJPEG  ZIP    239775   5-26-93   8:27a
    ...
    GO-STRT  DAT       539   5-26-93   9:07a
            9 file(s)     310940 bytes
                            6144 bytes free
