...
```
Disk No: 2404                                                           
Disk Title: DAYO Price Book                                             
PC-SIG Version: S1                                                      
                                                                        
Program Title: DAYO Price Book                                          
Author Version: 1.3                                                     
...
Inventory and DAYO POS (Point of Sale) programs/databases.  Customers   
are invoiced (with DAYO POS) using the price in the inventory database  
or with one of the special Price Book methods:  Fixed, Margin, List     
Discount.                                                               
...
```
╔═════════════════════════════════════════════════════════════════════════╗
║             <<<<  PC-SIG Disk #2404  DAYO PRICE BOOK   >>>>             ║
╠═════════════════════════════════════════════════════════════════════════╣
...
║ the DAYO package, which includes DAYO PRICE BOOKS.                      ║
║                                                                         ║
║ Otherwise, copy the contents of the DAYO module into a directory on     ║
║ your hard disk (i.e. \DAYOPB) and run the self-extracting file.  (It    ║
