...
```
Disk No: 2107                                                           
Disk Title: Cooper Graphics #8                                          
PC-SIG Version: S1                                                      
                                                                        
Program Title: Cooper Graphics #8                                       
Author Version: 2.1                                                     
...
Cooper Image Disk #8 contains sign language graphics, Indian-type       
symbols, Garfield faces, and a variety of funny faces for your desktop  
publisher.  It is one disk of an 18-disk graphic images library, each   
...
```
╔═════════════════════════════════════════════════════════════════════════╗
║              <<<<  Disk #2107 COOPER GRAPHIC #8  >>>>                   ║
╠═════════════════════════════════════════════════════════════════════════╣
║ For Printshop graphics, use files GRP08.*                               ║
║ To print documentation for Printshop graphics, type:                    ║
║                       COPY NUPSHOP.DOC PRN                              ║
║                                                                         ║
║ For Printmaster graphics, use files GPM08.*                             ║
║ To print documentation for Printmaster graphics, type:                  ║
║                       COPY OLDPMAS.DOC PRN                              ║
║                                                                         ║
║ To unarchive First Publisher Art Images graphics, type: CGART08         ║
║ To unarchive Gem Img Images graphics, type: CGIMG08                     ║
║ To unarchive MacPaint Mac Images graphics, type: CGMAC08                ║
║ To unarchive MicroSoft Paint MSP Images graphics, type: CGMSP08         ║
║ To unarchive PC Paintbrush PCX Imgages graphics, type: CGPCX08          ║
║                                                                         ║
║                                                                         ║
╚═════════════════════════════════════════════════════════════════════════╝
```
