...
```
Disk No: 2406                                                           
Disk Title: DAYO Index                                                  
PC-SIG Version: S1                                                      
                                                                        
Program Title: DAYO Index                                               
Author Version: 1.3                                                     
...
║ the DAYO package, which includes DAYO INDEX.                            ║
║                                                                         ║
║ Otherwise, copy the contents of the DAYO module into a directory on     ║
║ your hard disk (i.e. \DAYOX) and run the self-extracting file.  (It     ║
