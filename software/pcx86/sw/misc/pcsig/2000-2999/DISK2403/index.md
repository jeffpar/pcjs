...
```
Disk No: 2403                                                           
Disk Title: DAYO POS 2 of 2 (#2402 also)(Pt of Sale)                    
PC-SIG Version: S1                                                      
...
```
╔═════════════════════════════════════════════════════════════════════════╗
║        <<<<  PC-SIG Disk #2403  DAYO POS (POINT OF SALE)   >>>>         ║
║                     (Disk #2 of 2, #2402 also)                          ║
╠═════════════════════════════════════════════════════════════════════════╣
...
║                                                                         ║
║ Otherwise, copy the contents of this disk into the \DAYOPOS directory   ║
║ on your hard disk (see directions found on GO file, Disk #2402) and run ║
