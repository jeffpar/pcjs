...
(Not ARCed) Version 2.2 requires: DOS 2.0 or later, 400K RAM.
...
(ARCed) Version 2.6 requires: DOS 2.0 or later, 400K RAM, hard disk OR dual-
floppy system.
...
bels. (Not ARCed) Version 1.0 requires: MAILLIST, DOS 2.0 or later, 360K RAM.
...
information without notice.                                BONUS DISKS
...
Disks, may involve an extra shipping                 $4.00  
fee. All prices are in U.S. Dollars.
...
```
Disk No: 2076                                                           
Disk Title: Creativity Package 2 of 3 (2075, 2077)                      
PC-SIG Version: S1.1                                                    
...
LIST4.DBF     |
LISTS.MEM    /
THUNDOC.COM  Instruction manual (command is THUNDOC)
