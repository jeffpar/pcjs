...
DAYO SMART REPORTS contains many reports/routines that will help you    
manage your purchasing, inventory, invoices, back orders, sales, and    
your databases.  There are 22 Reports/Lists/Routines included in Smart  
...
```
╔═════════════════════════════════════════════════════════════════════════╗
║            <<<<  PC-SIG Disk #2417  DAYO SMART REPORTS  >>>>            ║
╠═════════════════════════════════════════════════════════════════════════╣
...
║ the DAYO package, which includes DAYO SMART REPORTS.                    ║
║                                                                         ║
║ Otherwise, copy the contents of the DAYO module into a directory on     ║
║ your hard disk (i.e. \DAYORPT) and run the self-extracting file.  (It   ║
