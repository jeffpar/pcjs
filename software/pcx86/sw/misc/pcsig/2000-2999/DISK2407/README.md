...
```
Disk No: 2407                                                           
Disk Title: DAYO Passwords                                              
PC-SIG Version: S1                                                      
                                                                        
Program Title: DAYO Passwords                                           
Author Version: 1.3                                                     
Author Registration: $25.00 (or included in $399.00 Basic DAYO Package) 
Special Requirements: 640K RAM, hard disk, and DOS 3.3.                 
                                                                        
DAYO PASSWORDS provide DAYO Business Application users with a system of 
database security through the use of passwords.  Its use is optional,   
but recommended in areas where more than one person has access to the   
data.                                                                   
...
```
╔═════════════════════════════════════════════════════════════════════════╗
║             <<<<  PC-SIG Disk #2407  DAYO PASSWORDS   >>>>              ║
╠═════════════════════════════════════════════════════════════════════════╣
...
║ the DAYO package, which includes DAYO PASSWORDS.                        ║
║                                                                         ║
║ Otherwise, copy the contents of the DAYO module into a directory on     ║
║ your hard disk (i.e. \DAYOPAS) and run the self-extracting file.  (It   ║
