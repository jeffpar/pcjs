...
```
Disk No: 2409                                                           
Disk Title: DAYO AR 1 of 2 (#2410 also) (Accts Rec)                     
PC-SIG Version: S1                                                      
                                                                        
Program Title: DAYO AR (Accounts Receivable)                            
Author Version: 1.3                                                     
...
```
╔═════════════════════════════════════════════════════════════════════════╗
║      <<<<  PC-SIG Disk #2409  DAYO AR (ACCOUNTS RECEIVABLE)  >>>>       ║
║                     (Disk #1 of 2, #2410 also)                          ║
╠═════════════════════════════════════════════════════════════════════════╣
...
║ your hard disk (i.e. \DAYOAR) and run the self-extracting file.  (It    ║
