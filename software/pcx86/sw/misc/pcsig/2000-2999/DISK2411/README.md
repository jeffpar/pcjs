...
```
Disk No: 2411                                                           
Disk Title: DAYO AP 1 of 2 (#2412 also) (Accts Pay)                     
PC-SIG Version: S1                                                      
...
```
╔═════════════════════════════════════════════════════════════════════════╗
║       <<<<  PC-SIG Disk #2411  DAYO AP (ACCOUNTS PAYABLE)  >>>>         ║
║                     (Disk #1 of 2, #2412 also)                          ║
╠═════════════════════════════════════════════════════════════════════════╣
...
║ your hard disk (i.e. \DAYOAP) and run the self-extracting file.  (It    ║
