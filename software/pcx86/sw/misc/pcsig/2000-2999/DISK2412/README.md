...
```
Disk No: 2412                                                           
Disk Title: DAYO AP 2 of 2 (#2411 also) (Accts Pay)                     
PC-SIG Version: S1                                                      
                                                                        
Program Title: DAYO AP (Accounts Payable)                               
Author Version: 1.3                                                     
Author Registration: $25.00 (or included in $399.00 Basic DAYO Package) 
Special Requirements: 640K RAM, hard disk, and DOS 3.3.                 
                                                                        
DAYO AP (ACCOUNTS PAYABLE) is the `final chapter' to the processing and 
maintenance of all your Payables.  DAYO AP's key mission is to process/ 
post your purchase orders; however, many other routines have been       
provided, i.e. Expense Maintenance, 1099 MISC Forms, Purchase Clearing, 
Vendor Maintenance, Hand/Manual Checks, Batch Checks, Recurring Checks, 
Unlimited Bank Accounts, Unlimited Check Printing Formats, and over 21  
Reports.                                                                
...
```
╔═════════════════════════════════════════════════════════════════════════╗
║       <<<<  PC-SIG Disk #2412  DAYO AP (ACCOUNTS PAYABLE)  >>>>         ║
║                     (Disk #2 of 2, #2411 also)                          ║
╠═════════════════════════════════════════════════════════════════════════╣
...
║ the DAYO package, which includes DAYO AP.                               ║
║                                                                         ║
║ Otherwise, copy the contents of this disk into your \DAYOAP directory   ║
║ on your hard disk (see directions found on GO file, Disk #2411) and run ║
