...
```
                       ...
                       Painless Accouting for Windows
                             Features Listing

     Painless Accounting for Windows is a fully integrated accounting
     (shareware) package. The modules included consist of: Files,
     Ledger, Billing, Checks, Reports, Closing, Budget, and Utilities.
     ...
     File:
       ...
       Services, Messages, and your company information.

     Ledger:
       All modules post to the Ledger. The Ledger consists of
       Enter/Edit Transactions, Activity Report, Journal Report, and
       Posting Process.

     Billing:
       The Billing Module allows you to enter and print invoices to
       your Clients. You may enter, Products, Service, or Message on
       an invoice. Sales Tax is automatically calculated based on
       whether the Product/Service is taxable and the rate in the
       sales tax file. This module also give you the ability to enter
       Cash Receipts from your clients. Through this module you may
       also print a Revenue Journal, Cash Receipts Journal, and Post
       the information to the Ledger.

     Checks:
       The Checks Module give you the ability to enter and print
       checks. You can also do a check reconciliation of all checks
       entered through this module. You can also post all the
       information to the Ledger.

     Reports:
       This module allows you to print the following reports:
          A) Trial Balance
          B) Balance Sheet
          C) Income Statement
          D) Client Aging
          ...
          J) Service Listing
          K) Message Listing
          L) Chart of Account Listing
          M) Vendor Listing

       All reports and journal may be printed to your printer or
       displayed to the screen.


     Budget:
       This module allows you to enter and edit your budget figures.
       You can also print your budgeted figures, actual figures, and
       a variance report comparing these figure.

     Utilities:
       This module contains all the miscellaneous options for
       Painless Accounting for Windows. This option allows your to
       display your file sizes, reindex your files, backup and restore
       your data files, setup your print, and enter text that will be
       printed at the bottom of your clients statements.

     Closing:
       This module is mainly used at the end of the month. This option
       allows you to run End of Month for: Ledger, and Billing You can
       also run End of Year for the General Ledger, and Purge the
       Client Historical File, and Historical Check File.
     ...
     Painless Accounting for Windows registration is $99.95. This will
     include a printed manual, along with the latest version.

...
```
Disk No: 2871
Disk Title: Painless Accounting For Windows 1/2
...
{% raw %}
```
                            PAINLESS ACCOUNTING FORMS                 Page: 1

 QTY              100    250     500     1000    2000    3000    4000    5000

 9 1/2 X 11  2PT         53.50   94.95  139.95  242.95  355.00  435.00  499.00
 INVOICES    3PT         59.50  109.95  176.00  310.00  465.00  604.95  649.00
             4PT         71.95  134.95  219.50  399.00  576.00  749.95  849.00
 9 1/2 X 7
 STATEMENTS  1PT         34.95   48.95   64.95   98.00  137.95  164.50  175.95
             2PT         42.95   63.95   95.00  147.95  205.00  269.00  300.00
 Colors Available on Invoices and Statements:  Black,  Blue,  Green,  Red
 * Note: Invoice and Statement prices include shipping charges.

 9 1/2 X 7    Payroll/Accounting
 CHECKS      1PT  19.95  41.95   54.95   72.95  111.00  139.00  169.00  195.00
 DOUBLE WINDOW
 ENVELOPES        12.60  23.10   31.50   46.70   86.10  125.00  162.95  183.00
 SHIPPING          2.32   3.26    3.66    4.50    6.80    8.75   11.25   14.75
 Colors Available:  Gold,  Blue,  Pink,  Green
 ** Check orders must be accompanied by a voided blank check. Write "VOID"
    over signature line in ink. Do not write on printing or lines.

 CAREFULLY PRINT WHAT YOU WANT PRINTED ON YOUR FORMS, OR SUPPLY A MOCK-UP.

 LINE1______________________________________      SHIP TO: (No PO Boxes)

 LINE2______________________________________      _________________________

 LINE3______________________________________      _________________________

 LINE4______________________________________      _________________________

 Typestyles: 1. Helios  2. Helios Italic  3. Helios Bold
 Guarantee: Quality, Spelling, and numbering are 100% guaranteed. If for any
 reason you are not satisifed with our forms, simply return the forms for a
 refund.

 Item   Qty    Paper Color    Ink Color  Typestyle  Starting # Cost   Total

 ______ ______ ______________ __________ __________ __________ ______ ______
 ...
 ___ Check  ___ Money Order  ___ VISA  ___ M/C               Subtotal ______

 Credit Card# ____________________________       NC Residents Add Tax ______

 Signature _______________________________             Total Shipping ______

 Expires _____________                                 Total Enclosed ______
 Mail To:  Compatible Forms & Checks
                PO Box 669324                     Marketing Code: 00307
           Charlotte, NC 28266-9324
        704-393-8292  Fax: 704-393-7874           *** Add $10.00 for Camera
                800-654-9044                          Ready Logo.

                                                                      Page: 2

 QTY              100    250     500     1000    2000    3000    4000    5000
 QUALITY BOND CONTINUOUS
 LETTERHEAD       19.95  25.50   36.50   45.10   73.50   83.50   95.00  115.00
 MATCHING ENV.    19.95  26.10   38.80   55.60   94.45  125.00  161.00  195.30
 SHIPPING          2.32   2.75    3.00    4.70    8.55   10.26   13.68   17.10
 Colors Available:  White,  Pink,  Canary,  Blue,  Recycled(off white only)

 25% COTTON FIBER CONTINUOUS
 LETTERHEAD       22.95  29.95   49.95   69.95   99.95  113.00  145.00  175.00
 MATCHING ENV.    22.95  33.95   54.95   89.95  159.95  193.00  251.00  300.00
 SHIPPING          2.32   2.75    3.00    4.70    8.55   10.26   13.68   17.10
 Available in White Only

 SUPER QUALITY CLASSIC LAID
 LETTERHEAD       22.95  29.95   49.95   69.95   99.95  113.00  145.00  175.00
 MATCHING ENV.    22.95  29.95   39.95   59.95  159.95  193.00  251.00  300.00
 SHIPPING          2.32   2.75    3.00    4.70    8.55   10.26   13.68   17.10
 Colors Available:  White,  Gray,  Tan,  Ivory
```
{% endraw %}
...
```
         ...
         P A I N L E S S  A C C O U N T I N G  for  W I N D O W S
         --------------------------------------------------------
             ...
             Copyright (c) 1990 by Painless Accounting, Inc.
                       All Rights Reserved.
...
Painless Accounting for Windows package.
...

          ...
          - Painless Accounting for Windows          - Vendor.DOC -
...
---------------------------------
   PAINLESS ACCOUNTING for WINDOWS - Business/Accounting

   ACCOUNTING, BILLING, CHECKS, LEDGER, CHECKS, RECONCILIATION,
   REGISTER, INVOICE, STATEMENTS, AGING, HELP, ASP
...
------------------
   ...
   PAINLESS ACCOUNTING for WINDOWS - The Painless Accounting for
   Windows is a full featured accounting system, designed for use
   with Windows 3.0. Modules include: Files, Ledger, Billing, Checks,
   Reports, Utilities, Budget, and Closing. The files are stored in
   .dBASE-III format for easy access by other applications. You can
   print client invoices, and statements to plain paper or pre-printed
   forms. Also, prints checks and many other reports including a Trial
   Balance, Balance Sheet, and Income Statement. You can also track
   your budget and compare your actual figures to your budgeted
   figures.

Long Description
----------------
Please see FEATURES.TXT
...
Painless Accounting, Inc. is a small software company owned by Kendall
B. Pierce.

At Painless Accounting, Inc. we are committed to producing quality,
user friendly software, at a reasonable price.
...
As the exclusive copyright holder for Painless Accounting for Windows,
Painless Accounting Inc. authorizes distribution only in accordance
with the following restrictions.  Please refer to the additional
information listed below which is specific to ASP and non-ASP Disk
Vendors, Computer Clubs, and Disk-of-the-Month style distribution.

The Painless Accounting for Windows package is defined as containing
all the material listed in the README.1ST text file.  If any files
listed in the README.1ST text file, or the README.1ST file itself, are
...
for distribution.
    ...
    o  The Painless Accounting for Windows - including all related
       program files and documentation files - CANNOT be modified in
       any way and must be distributed as a complete package, without
       exception.  The README.1ST text file contains a list of all
       files that are part of the Painless Accounting for Windows.

    o  No price or other compensation may be charged for the
       Painless Accounting for Windows. A distribution cost may be
       charged for the cost of the diskette, shipping and
       handling.

    o  The Painless Accounting for Windows CANNOT be sold as part of
       some other inclusive package.  Nor can it be included in any
       commercial software packaging offer, without a written
       agreement from Painless Accounting, Inc.  For information on
       combining the Painless Accounting for Windows with related
       programs to form a "disk-set", please refer to the information
...

    ...
    o  The PRINTED User's Guide may not be reproduced in whole or
       ...
       of Painless Accounting, Inc. In other words, the disk-based
       documentation may not be distributed in PRINTED (hardcopy)
       form.

    o  The Painless Accounting for Windows cannot be "rented" or
       "leased" to others.

    o  The person receiving a copy of the Painless Accounting for
       Windows MUST be made aware that each disk or copy is ONLY for
       evaluation, and that Painless Accounting, Inc. has not received
       any royalties or payment for the product.  This requirement can
       be met by including the complete Painless Accounting for
       Windows package, which contains any appropriate registration
       reminders.

    o  The person receiving a copy of the Painless Accounting for
       Windows MUST be made aware that he or she does not become a
       registered user until Painless Accounting, Inc. has received
       payment for registration of the software.  This requirement can
       be met by including the complete Painless Accounting for
       Windows, which contains any appropriate registration reminders.

    o  Painless Accounting, Inc. prohibits the distribution of
       outdated versions of the Painless Accounting for Windows,
       ...
       version was released in September, 1991.
    ...
    o  U.S. Government Information:  Use, duplication, or
       ...
       Contractor/manufacturer is: Painless Accounting, Inc.
                                   4401 Birdsong
                                   Plano, TX 75075
...
Clubs who wish to distribute the Painless Accounting for Windows.
...
given permission to distribute the Painless Accounting for Windows in
...
distributed by Painless Accounting, Inc.

ASP Vendor Members - Disk Sets:
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
ASP Vendor Members who wish to distribute the Painless Accounting,
Inc. package as part of a collection (such as PsL's MegaDisk set, or a
CD-ROM package) may do so provided that all the other restrictions
listed above are met.  Please check the release date of the version
you have.  If the version is over twelve (12) months old then please
contact us to ensure that you have the most current version.  This
version was released in September, 1991.
...
Members, but who wish to distribute the Painless Accounting for
Windows must comply with the following restrictions (in addition to
those listed above, beginning on page 4).

In order for us to ensure that only current versions are
distributed, we require that you request permission from us
(Painless Accounting, Inc.) to distribute any of our products.
...
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
Vendors (non-ASP Vendor Members) who wish to distribute the Painless
Accounting for Windows as part of a collection (such as PsL's MegaDisk
set, or a CD-ROM package) must obtain permission from Painless
Accounting, Inc. prior to beginning such a distribution.
...
Inc. package to their disk library may do so in accordance with the
...
If you would like to distribute the Painless Accounting for Windows as
a Disk-of-the-Month, or as part of a subscription or monthly service,
then the following restrictions apply:

ASP Associate (Disk Vendor) Members in good standing are hereby given
permission to distribute the Painless Accounting for Windows under the
...
Painless Accounting, Inc.  Please send us a copy of any reviews,
articles, catalog descriptions, or other information you print or
distribute regarding the Painless Accounting for Windows.  Thank you
