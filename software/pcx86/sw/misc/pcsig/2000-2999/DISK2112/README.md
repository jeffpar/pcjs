...
```
Disk No: 2112                                                           
Disk Title: Cooper Graphics #13                                         
PC-SIG Version: S1                                                      
                                                                        
Program Title: Cooper Graphics #13                                      
Author Version: 2.1                                                     
...
Do you need a wide assortment of Christmas graphics to choose from?     
Cooper Images #13 has probably more than you would have imagined and    
will fit any creative Christmas occasion.  This is one disk of an       
18-disk graphic images library, each containing 100 images shown in the 
catalog sheets under the library number.  The Print Shop and Printmaster
...
```
╔═════════════════════════════════════════════════════════════════════════╗
║              <<<<  Disk #2112 COOPER GRAPHIC #13  >>>>                  ║
╠═════════════════════════════════════════════════════════════════════════╣
║ For Printshop graphics, use files GRP13.*                               ║
║ To print documentation for Printshop graphics, type:                    ║
║                       COPY NUPSHOP.DOC PRN                              ║
║                                                                         ║
║ For Printmaster graphics, use files GPM13.*                             ║
║ To print documentation for Printmaster graphics, type:                  ║
║                       COPY OLDPMAS.DOC PRN                              ║
║                                                                         ║
║ To unarchive First Publisher Art Images graphics, type: CGART13         ║
║ To unarchive Gem Img Images graphics, type: CGIMG13                     ║
║ To unarchive MacPaint Mac Images graphics, type: CGMAC13                ║
║ To unarchive MicroSoft Paint MSP Images graphics, type: CGMSP13         ║
║ To unarchive PC Paintbrush PCX Imgages graphics, type: CGPCX13          ║
║                                                                         ║
║                                                                         ║
╚═════════════════════════════════════════════════════════════════════════╝
```
