...
```
Disk No: 2113                                                           
Disk Title: Cooper Graphics #14                                         
PC-SIG Version: S1                                                      
                                                                        
Program Title: Cooper Graphics #14                                      
Author Version: 2.1                                                     
...
Numbered and lettered black and white cue balls are eye catchers for    
Cooper Images Disk #14.  Military stripes, old cars, cartoon characters,
and other graphics comprise the variety on this diskette.  This is one  
...
```
╔═════════════════════════════════════════════════════════════════════════╗
║              <<<<  Disk #2113 COOPER GRAPHIC #14 >>>>                   ║
╠═════════════════════════════════════════════════════════════════════════╣
║ For Printshop graphics, use files GRP14.*                               ║
║ To print documentation for Printshop graphics, type:                    ║
║                       COPY NUPSHOP.DOC PRN                              ║
║                                                                         ║
║ For Printmaster graphics, use files GPM14.*                             ║
║ To print documentation for Printmaster graphics, type:                  ║
║                       COPY OLDPMAS.DOC PRN                              ║
║                                                                         ║
║ To unarchive First Publisher Art Images graphics, type: CGART14         ║
║ To unarchive Gem Img Images graphics, type: CGIMG14                     ║
║ To unarchive MacPaint Mac Images graphics, type: CGMAC14                ║
║ To unarchive MicroSoft Paint MSP Images graphics, type: CGMSP14         ║
║ To unarchive PC Paintbrush PCX Imgages graphics, type: CGPCX14          ║
║                                                                         ║
║                                                                         ║
╚═════════════════════════════════════════════════════════════════════════╝
```
