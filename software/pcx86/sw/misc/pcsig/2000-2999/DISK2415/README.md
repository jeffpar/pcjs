...
```
Disk No: 2415                                                           
Disk Title: DAYO Look Up (Database Look Up)                             
PC-SIG Version: S1                                                      
                                                                        
Program Title: DAYO Look Up (Database Look Up)                          
Author Version: 1.3                                                     
...
```
╔═════════════════════════════════════════════════════════════════════════╗
║       <<<<  PC-SIG Disk #2415  DAYO LOOKUP (DATABASE LOOKUP)  >>>>      ║
╠═════════════════════════════════════════════════════════════════════════╣
...
║ the DAYO package, which includes DAYO LOOKUP.                           ║
║                                                                         ║
║ Otherwise, copy the contents of the DAYO module into a directory on     ║
║ your hard disk (i.e. \DAYOLU) and run the self-extracting file.  (It    ║
