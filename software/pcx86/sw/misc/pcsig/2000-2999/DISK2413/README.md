...
```
Disk No: 2413                                                           
Disk Title: DAYO GL 1 of 2 (#2414 also)(Genl Ledger)                    
PC-SIG Version: S1                                                      
...
```
╔═════════════════════════════════════════════════════════════════════════╗
║           <<<<  PC-SIG Disk #2413  GL (GENERAL LEDGER)  >>>>            ║
║                     (Disk #1 of 2, #2414 also)                          ║
╠═════════════════════════════════════════════════════════════════════════╣
...
║ your hard disk (i.e. \DAYOGL) and run the self-extracting file.  (It    ║
