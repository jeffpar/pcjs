...
recreated them as a set of [PC Tech Journal Disks](/software/pcx86/sw/magazines/pctj/), and added them to the
PCjs Software Library, so now you can "Load" and "Save" them in any PCx86 machine.

Next, since I was also a fan of PC Magazine back in the day, I decided to do the same for all the PC Magazine ZIP
archives.  So now there's a set of [PC Magazine Disks](/software/pcx86/sw/magazines/pcm/) you can play with as well.
...
> for references to the "PLAY" files contained in one of the older archived [PC Magazine Disks](/software/pcx86/sw/magazines/pcm/).
