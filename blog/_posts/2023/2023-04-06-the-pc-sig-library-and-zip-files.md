...
Here's a list of the new JavaScript modules:
  ...
  - [BASConvert.js](https://github.com/jeffpar/pcjs/tree/master/tools/basconvert/basconvert.js), a BASIC de-tokenizer and character conversion library, which also uses [CharSet.js](https://github.com/jeffpar/pcjs/tree/master/machines/pcx86/modules/v3/charset.js)
...
Last but not least, I've also added a [BASIC Conversion Utility](/tools/basconvert/) page that loads [BASConvert](https://github.com/jeffpar/pcjs/tree/master/tools/basconvert/basconvert.js) in your web browser.  It should be able to convert any old IBM PC BASIC file to plain text, but again, if you run into any interesting discrepancies, [let me know](mailto:Jeff@pcjs.org).
